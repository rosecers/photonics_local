...
(set! k-points (interpolate 1 (list
			...
			(vector3 0.33333333 -0.66666667 0.0)			;V62
			(vector3 0.33333333 -0.66666667 0.5)			;V63
...
(set! geometry (list (make sphere (center 0.491 0.037 0.0) (radius r) (material diel))

	(make sphere (center 0.963 0.454 0.0) (radius r) (material diel))

	(make sphere (center 0.546 0.509 0.0) (radius r) (material diel))

	(make sphere (center 0.508 0.87 0.347) (radius r) (material diel))

	(make sphere (center 0.13 0.638 0.347) (radius r) (material diel))

	(make sphere (center 0.362 0.492 0.347) (radius r) (material diel))

	(make sphere (center 0.332 0.841 0.333) (radius r) (material diel))

	(make sphere (center 0.159 0.491 0.333) (radius r) (material diel))

	(make sphere (center 0.509 0.668 0.333) (radius r) (material diel))

	(make sphere (center 0.204 0.049 0.681) (radius r) (material diel))

	(make sphere (center 0.951 0.155 0.681) (radius r) (material diel))

	(make sphere (center 0.845 0.796 0.681) (radius r) (material diel))

	(make sphere (center 0.17 0.161 0.667) (radius r) (material diel))

	(make sphere (center 0.839 0.009 0.667) (radius r) (material diel))

	(make sphere (center 0.991 0.83 0.667) (radius r) (material diel))

	(make sphere (center 0.275 0.182 0.986) (radius r) (material diel))

	(make sphere (center 0.818 0.093 0.986) (radius r) (material diel))

	(make sphere (center 0.907 0.725 0.986) (radius r) (material diel))
))
