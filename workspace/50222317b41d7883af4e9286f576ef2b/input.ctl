(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.93795243) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.9379524315)))
...
(set! geometry (list (make sphere (center 0.0333333333 0.3666666667 0.4) (radius r) (material diel))

	(make sphere (center 0.3666666667 0.0333333333 -0.1) (radius r) (material diel))

	(make sphere (center -0.3 -0.3 -0.1) (radius r) (material diel))

	(make sphere (center -0.3 -0.3 0.4) (radius r) (material diel))

	(make sphere (center 0.058999995 -0.3 -0.35) (radius r) (material diel))

	(make sphere (center 0.058999995 0.058999995 0.15) (radius r) (material diel))

	(make sphere (center -0.3 0.058999995 -0.35) (radius r) (material diel))

	(make sphere (center 0.341000005 -0.3 0.15) (radius r) (material diel))

	(make sphere (center 0.341000005 0.341000005 -0.35) (radius r) (material diel))

	(make sphere (center -0.3 0.341000005 0.15) (radius r) (material diel))
))
