...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.34627143) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.3462714272)))
...
(set! geometry (list (make sphere (center 0.0 0.0 0.25) (radius r) (material diel))
	...
	(make sphere (center 0.6666666666666666 0.904 0.0) (radius r) (material diel))

	(make sphere (center 0.429 0.429 0.0) (radius r) (material diel))

	(make sphere (center 0.904 0.6666666666666666 0.0) (radius r) (material diel))

	(make sphere (center 0.763 0.6666666666666666 0.5) (radius r) (material diel))

	(make sphere (center 0.0 0.429 0.5) (radius r) (material diel))

	(make sphere (center 0.238 0.904 0.5) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.0 0.155) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.0 0.845) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.3333333333333333 0.155) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.3333333333333333 0.845) (radius r) (material diel))

	(make sphere (center 0.0 0.6666666666666666 0.155) (radius r) (material diel))

	(make sphere (center 0.0 0.6666666666666666 0.845) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.6666666666666666 0.655) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.6666666666666666 0.345) (radius r) (material diel))

	(make sphere (center 0.0 0.3333333333333333 0.655) (radius r) (material diel))

	(make sphere (center 0.0 0.3333333333333333 0.345) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.0 0.655) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.0 0.345) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.448 0.0) (radius r) (material diel))

	(make sphere (center 0.885 0.885 0.0) (radius r) (material diel))

	(make sphere (center 0.448 0.6666666666666666 0.0) (radius r) (material diel))

	(make sphere (center 0.219 0.6666666666666666 0.5) (radius r) (material diel))

	(make sphere (center 0.0 0.885 0.5) (radius r) (material diel))

	(make sphere (center 0.782 0.448 0.5) (radius r) (material diel))
))
