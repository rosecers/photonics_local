(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.20727417) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.207274172)))
...
(set! geometry (list (make sphere (center -0.1568627451 0.2156862745 -0.4411764706) (radius r) (material diel))

	(make sphere (center -0.4901960784 -0.4509803922 -0.4411764706) (radius r) (material diel))

	(make sphere (center 0.0146189199 -0.4413503955 0.0588235294) (radius r) (material diel))

	(make sphere (center 0.5001739249 0.0442046095 0.0588235294) (radius r) (material diel))

	(make sphere (center 0.0146189199 0.0442046095 0.0588235294) (radius r) (material diel))

	(make sphere (center -0.1414960751 -0.4468803955 -0.1576764706) (radius r) (material diel))

	(make sphere (center 0.5057039249 -0.1063803855 -0.1576764706) (radius r) (material diel))

	(make sphere (center 0.1652039149 0.2003196045 -0.1576764706) (radius r) (material diel))

	(make sphere (center -0.1414960751 -0.1063803855 0.2753235294) (radius r) (material diel))

	(make sphere (center 0.5057039249 0.2003196045 0.2753235294) (radius r) (material diel))

	(make sphere (center 0.1652039149 -0.4468803955 0.2753235294) (radius r) (material diel))

	(make sphere (center -0.2321960751 0.5453196045 -0.2756764706) (radius r) (material diel))

	(make sphere (center -0.4864960751 -0.1892803855 -0.2756764706) (radius r) (material diel))

	(make sphere (center 0.2481039149 0.2910196045 -0.2756764706) (radius r) (material diel))

	(make sphere (center -0.2321960751 -0.1892803855 0.3933235294) (radius r) (material diel))

	(make sphere (center -0.4864960751 0.2910196045 0.3933235294) (radius r) (material diel))

	(make sphere (center 0.2481039149 0.5453196045 0.3933235294) (radius r) (material diel))
))
