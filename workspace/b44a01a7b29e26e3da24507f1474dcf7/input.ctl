...
(set! geometry (list (make sphere (center -0.041 -0.13 -0.219) (radius r) (material diel))

	(make sphere (center 0.041 0.13 0.219) (radius r) (material diel))

	(make sphere (center -0.459 -0.178 0.411) (radius r) (material diel))

	(make sphere (center 0.459 0.178 -0.411) (radius r) (material diel))

	(make sphere (center 0.411 -0.37 0.089) (radius r) (material diel))

	(make sphere (center -0.411 0.37 -0.089) (radius r) (material diel))

	(make sphere (center 0.089 -0.322 -0.281) (radius r) (material diel))

	(make sphere (center -0.089 0.322 0.281) (radius r) (material diel))

	(make sphere (center -0.322 -0.281 0.089) (radius r) (material diel))

	(make sphere (center 0.322 0.281 -0.089) (radius r) (material diel))

	(make sphere (center -0.37 0.089 0.411) (radius r) (material diel))

	(make sphere (center 0.37 -0.089 -0.411) (radius r) (material diel))

	(make sphere (center -0.178 0.411 -0.459) (radius r) (material diel))

	(make sphere (center 0.178 -0.411 0.459) (radius r) (material diel))

	(make sphere (center -0.13 -0.219 -0.041) (radius r) (material diel))

	(make sphere (center 0.13 0.219 0.041) (radius r) (material diel))

	(make sphere (center 0.089 0.411 -0.37) (radius r) (material diel))

	(make sphere (center -0.089 -0.411 0.37) (radius r) (material diel))

	(make sphere (center -0.281 0.089 -0.322) (radius r) (material diel))

	(make sphere (center 0.281 -0.089 0.322) (radius r) (material diel))

	(make sphere (center -0.219 -0.041 -0.13) (radius r) (material diel))

	(make sphere (center 0.219 0.041 0.13) (radius r) (material diel))

	(make sphere (center 0.411 -0.459 -0.178) (radius r) (material diel))

	(make sphere (center -0.411 0.459 0.178) (radius r) (material diel))

	(make sphere (center -0.041 0.089 -0.322) (radius r) (material diel))

	(make sphere (center 0.041 -0.089 0.322) (radius r) (material diel))

	(make sphere (center -0.459 -0.281 -0.37) (radius r) (material diel))

	(make sphere (center 0.459 0.281 0.37) (radius r) (material diel))

	(make sphere (center 0.411 -0.219 -0.178) (radius r) (material diel))

	(make sphere (center -0.411 0.219 0.178) (radius r) (material diel))

	(make sphere (center 0.089 0.411 -0.13) (radius r) (material diel))

	(make sphere (center -0.089 -0.411 0.13) (radius r) (material diel))

	(make sphere (center -0.322 -0.041 0.089) (radius r) (material diel))

	(make sphere (center 0.322 0.041 -0.089) (radius r) (material diel))

	(make sphere (center -0.37 -0.459 -0.281) (radius r) (material diel))

	(make sphere (center 0.37 0.459 0.281) (radius r) (material diel))

	(make sphere (center -0.178 0.411 -0.219) (radius r) (material diel))

	(make sphere (center 0.178 -0.411 0.219) (radius r) (material diel))

	(make sphere (center -0.13 0.089 0.411) (radius r) (material diel))

	(make sphere (center 0.13 -0.089 -0.411) (radius r) (material diel))

	(make sphere (center 0.089 -0.322 -0.041) (radius r) (material diel))

	(make sphere (center -0.089 0.322 0.041) (radius r) (material diel))

	(make sphere (center -0.281 -0.37 -0.459) (radius r) (material diel))

	(make sphere (center 0.281 0.37 0.459) (radius r) (material diel))

	(make sphere (center -0.219 -0.178 0.411) (radius r) (material diel))

	(make sphere (center 0.219 0.178 -0.411) (radius r) (material diel))

	(make sphere (center 0.411 -0.13 0.089) (radius r) (material diel))
	...
	(make sphere (center -0.25 -0.125 -0.375) (radius r) (material diel))

	(make sphere (center 0.25 0.125 0.375) (radius r) (material diel))

	(make sphere (center 0.25 -0.375 -0.125) (radius r) (material diel))
