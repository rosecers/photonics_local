...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.99208536) (basis1 1.0 0.0 0.0) (basis2 -0.500000000009203 0.8660254037823619 0.0) (basis3 0.0 0.0 0.9920853634261207)))
...
(set! geometry (list (make sphere (center 0.5 0.0 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.0 0.0 0.3333333333333333) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.8333333333333334) (radius r) (material diel))
