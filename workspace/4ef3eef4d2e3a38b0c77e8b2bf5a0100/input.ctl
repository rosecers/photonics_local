(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.88439826) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.8843982614)))
...
(set! geometry (list (make sphere (center 0.2311111111 -0.3698888889 -0.1666666667) (radius r) (material diel))

	(make sphere (center 0.0101111111 -0.0088888889 -0.1666666667) (radius r) (material diel))

	(make sphere (center 0.5921111111 0.2121111111 -0.1666666667) (radius r) (material diel))

	(make sphere (center -0.3698888889 0.2311111111 0.3333333333) (radius r) (material diel))

	(make sphere (center 0.2121111111 0.5921111111 0.3333333333) (radius r) (material diel))

	(make sphere (center -0.0088888889 0.0101111111 0.3333333333) (radius r) (material diel))

	(make sphere (center -0.0998888889 -0.3888888889 -0.4166666667) (radius r) (material diel))

	(make sphere (center 0.3221111111 0.3221111111 0.0833333333) (radius r) (material diel))

	(make sphere (center -0.3888888889 -0.0998888889 -0.4166666667) (radius r) (material diel))

	(make sphere (center -0.0998888889 -0.3888888889 0.0833333333) (radius r) (material diel))

	(make sphere (center 0.3221111111 0.3221111111 -0.4166666667) (radius r) (material diel))

	(make sphere (center -0.3888888889 -0.0998888889 0.0833333333) (radius r) (material diel))

	(make sphere (center -0.3888888889 -0.3888888889 -0.1666666667) (radius r) (material diel))

	(make sphere (center -0.3888888889 -0.3888888889 0.3333333333) (radius r) (material diel))

	(make sphere (center -0.0555555556 0.2777777778 -0.3786666667) (radius r) (material diel))

	(make sphere (center -0.0555555556 0.2777777778 0.0453333333) (radius r) (material diel))

	(make sphere (center 0.2777777778 -0.0555555556 0.1213333333) (radius r) (material diel))

	(make sphere (center 0.2777777778 -0.0555555556 0.5453333333) (radius r) (material diel))
))
