...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.02444444) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0244444417)))
...
(set! geometry (list (make sphere (center 0.2417333333 -0.4166666667 -0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 0.2417333333 -0.25) (radius r) (material diel))

	(make sphere (center -0.0750666667 -0.0750666667 -0.25) (radius r) (material diel))

	(make sphere (center -0.0750666667 -0.4166666667 0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.0750666667 0.25) (radius r) (material diel))

	(make sphere (center 0.2417333333 0.2417333333 0.25) (radius r) (material diel))

	(make sphere (center -0.0519666667 -0.3634666667 -0.419) (radius r) (material diel))

	(make sphere (center 0.5301333333 -0.1051666667 -0.419) (radius r) (material diel))

	(make sphere (center 0.2718333333 0.2186333333 -0.419) (radius r) (material diel))

	(make sphere (center -0.3634666667 -0.0519666667 -0.081) (radius r) (material diel))

	(make sphere (center 0.2186333333 0.2718333333 -0.081) (radius r) (material diel))

	(make sphere (center -0.1051666667 0.5301333333 -0.081) (radius r) (material diel))

	(make sphere (center 0.2186333333 0.5301333333 0.419) (radius r) (material diel))

	(make sphere (center -0.3634666667 0.2718333333 0.419) (radius r) (material diel))

	(make sphere (center -0.1051666667 -0.0519666667 0.419) (radius r) (material diel))

	(make sphere (center 0.5301333333 0.2186333333 0.081) (radius r) (material diel))

	(make sphere (center -0.0519666667 -0.1051666667 0.081) (radius r) (material diel))

	(make sphere (center 0.2718333333 -0.3634666667 0.081) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 -0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 0.25) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.313) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 -0.187) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.313) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 0.187) (radius r) (material diel))
))
