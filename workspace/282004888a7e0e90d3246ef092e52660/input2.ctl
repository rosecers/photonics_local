...
(set! geometry (list (make sphere (center -0.2625714286 0.0714285714 -0.4285714286) (radius r) (material diel))

	(make sphere (center -0.0945714286 -0.0945714286 -0.0945714286) (radius r) (material diel))

	(make sphere (center 0.0714285714 -0.4285714286 -0.2625714286) (radius r) (material diel))

	(make sphere (center -0.4285714286 -0.2625714286 0.0714285714) (radius r) (material diel))

	(make sphere (center 0.2374285714 0.0714285714 -0.4285714286) (radius r) (material diel))

	(make sphere (center 0.4054285714 0.4054285714 0.4054285714) (radius r) (material diel))

	(make sphere (center -0.4285714286 0.2374285714 0.0714285714) (radius r) (material diel))

	(make sphere (center 0.0714285714 -0.4285714286 0.2374285714) (radius r) (material diel))

	(make sphere (center -0.0535714286 0.1964285714 0.3214285714) (radius r) (material diel))

	(make sphere (center -0.3035714286 0.4464285714 -0.1785714286) (radius r) (material diel))

	(make sphere (center 0.1964285714 0.3214285714 -0.0535714286) (radius r) (material diel))

	(make sphere (center 0.4464285714 -0.1785714286 -0.3035714286) (radius r) (material diel))

	(make sphere (center -0.1785714286 -0.3035714286 0.4464285714) (radius r) (material diel))

	(make sphere (center 0.3214285714 -0.0535714286 0.1964285714) (radius r) (material diel))
))
