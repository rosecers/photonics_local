...
(set! geometry (list (make sphere (center -0.4444444444 -0.4444444444 -0.4444444444) (radius r) (material diel))

	(make sphere (center 0.3055555556 0.3055555556 0.3055555556) (radius r) (material diel))

	(make sphere (center -0.1944444444 -0.1944444444 -0.1944444444) (radius r) (material diel))

	(make sphere (center 0.3175555556 -0.2064444444 -0.2064444444) (radius r) (material diel))

	(make sphere (center -0.2064444444 0.3175555556 0.3175555556) (radius r) (material diel))

	(make sphere (center -0.2064444444 -0.2064444444 0.3175555556) (radius r) (material diel))

	(make sphere (center 0.3175555556 0.3175555556 -0.2064444444) (radius r) (material diel))

	(make sphere (center 0.3175555556 -0.2064444444 0.3175555556) (radius r) (material diel))

	(make sphere (center -0.2064444444 0.3175555556 -0.2064444444) (radius r) (material diel))
))
