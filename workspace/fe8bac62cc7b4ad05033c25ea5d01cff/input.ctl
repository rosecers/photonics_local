...
(set! geometry (list (make sphere (center -0.0421666667 -0.4161666667 -0.4161666667) (radius r) (material diel))

	(make sphere (center -0.4161666667 -0.0421666667 -0.0421666667) (radius r) (material diel))

	(make sphere (center -0.0421666667 -0.0421666667 -0.4161666667) (radius r) (material diel))

	(make sphere (center -0.4161666667 -0.4161666667 -0.0421666667) (radius r) (material diel))

	(make sphere (center -0.4161666667 -0.0421666667 -0.4161666667) (radius r) (material diel))

	(make sphere (center -0.0421666667 -0.4161666667 -0.0421666667) (radius r) (material diel))

	(make sphere (center 0.3308333333 -0.2891666667 -0.2891666667) (radius r) (material diel))

	(make sphere (center -0.2891666667 0.3308333333 0.3308333333) (radius r) (material diel))

	(make sphere (center 0.3308333333 0.3308333333 -0.2891666667) (radius r) (material diel))

	(make sphere (center -0.2891666667 -0.2891666667 0.3308333333) (radius r) (material diel))

	(make sphere (center -0.2891666667 0.3308333333 -0.2891666667) (radius r) (material diel))

	(make sphere (center 0.3308333333 -0.2891666667 0.3308333333) (radius r) (material diel))

	(make sphere (center 0.1718333333 0.1718333333 -0.4321666667) (radius r) (material diel))

	(make sphere (center -0.4321666667 0.1718333333 0.1718333333) (radius r) (material diel))

	(make sphere (center 0.1718333333 0.1718333333 0.1718333333) (radius r) (material diel))

	(make sphere (center 0.1718333333 -0.4321666667 0.1718333333) (radius r) (material diel))

	(make sphere (center 0.3788333333 0.3788333333 -0.0531666667) (radius r) (material diel))

	(make sphere (center -0.0531666667 0.3788333333 0.3788333333) (radius r) (material diel))

	(make sphere (center 0.3788333333 0.3788333333 0.3788333333) (radius r) (material diel))

	(make sphere (center 0.3788333333 -0.0531666667 0.3788333333) (radius r) (material diel))

	(make sphere (center -0.0611666667 -0.0611666667 0.2668333333) (radius r) (material diel))

	(make sphere (center 0.2668333333 -0.0611666667 -0.0611666667) (radius r) (material diel))

	(make sphere (center -0.0611666667 -0.0611666667 -0.0611666667) (radius r) (material diel))

	(make sphere (center -0.0611666667 0.2668333333 -0.0611666667) (radius r) (material diel))
))
