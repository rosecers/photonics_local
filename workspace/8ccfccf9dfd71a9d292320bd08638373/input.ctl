(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.93357496) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.9335749586)))
...
(set! geometry (list (make sphere (center 0.3333333333333333 0.0 0.0) (radius r) (material diel))

	(make sphere (center 0.0 0.3333333333333333 0.0) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.6666666666666666 0.0) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.0 0.5) (radius r) (material diel))

	(make sphere (center 0.0 0.6666666666666666 0.5) (radius r) (material diel))
