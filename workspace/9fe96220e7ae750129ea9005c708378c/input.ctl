...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.39082572) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.3908257228)))
...
(set! geometry (list (make sphere (center -0.3978888889 -0.0741111111 -0.0023333333) (radius r) (material diel))

	(make sphere (center 0.0741111111 0.3428888889 -0.0023333333) (radius r) (material diel))

	(make sphere (center -0.3428888889 0.3978888889 -0.0023333333) (radius r) (material diel))

	(make sphere (center -0.3808888889 -0.2411111111 0.3446666667) (radius r) (material diel))

	(make sphere (center 0.2411111111 0.5268888889 0.3446666667) (radius r) (material diel))

	(make sphere (center -0.5268888889 0.3808888889 0.3446666667) (radius r) (material diel))

	(make sphere (center 0.4431111111 -0.2701111111 0.3306666667) (radius r) (material diel))

	(make sphere (center 0.2701111111 0.3798888889 0.3306666667) (radius r) (material diel))

	(make sphere (center -0.3798888889 -0.4431111111 0.3306666667) (radius r) (material diel))

	(make sphere (center 0.3151111111 -0.0621111111 -0.3213333333) (radius r) (material diel))

	(make sphere (center 0.0621111111 0.0438888889 -0.3213333333) (radius r) (material diel))

	(make sphere (center -0.0438888889 -0.3151111111 -0.3213333333) (radius r) (material diel))

	(make sphere (center 0.2811111111 0.0498888889 -0.3353333333) (radius r) (material diel))

	(make sphere (center -0.0498888889 -0.1021111111 -0.3353333333) (radius r) (material diel))

	(make sphere (center 0.1021111111 -0.2811111111 -0.3353333333) (radius r) (material diel))

	(make sphere (center 0.3861111111 0.0708888889 -0.0163333333) (radius r) (material diel))

	(make sphere (center -0.0708888889 -0.0181111111 -0.0163333333) (radius r) (material diel))

	(make sphere (center 0.0181111111 -0.3861111111 -0.0163333333) (radius r) (material diel))
))
