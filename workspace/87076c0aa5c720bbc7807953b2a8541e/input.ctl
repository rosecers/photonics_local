(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.00919378) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0091937817)))
...
(set! geometry (list (make sphere (center -0.4166666667 -0.4166666667 -0.4791666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 0.0208333333) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.3091666667) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 0.1908333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.3508333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 -0.1491666667) (radius r) (material diel))

	(make sphere (center 0.2733333333 -0.3466666667 -0.3991666667) (radius r) (material diel))

	(make sphere (center 0.5133333333 0.2033333333 -0.3991666667) (radius r) (material diel))

	(make sphere (center -0.0366666667 -0.1066666667 -0.3991666667) (radius r) (material diel))

	(make sphere (center 0.5133333333 -0.1066666667 0.1008333333) (radius r) (material diel))

	(make sphere (center 0.2733333333 0.2033333333 0.1008333333) (radius r) (material diel))

	(make sphere (center -0.0366666667 -0.3466666667 0.1008333333) (radius r) (material diel))

	(make sphere (center -0.1066666667 0.5133333333 0.4408333333) (radius r) (material diel))

	(make sphere (center -0.3466666667 -0.0366666667 0.4408333333) (radius r) (material diel))

	(make sphere (center 0.2033333333 0.2733333333 0.4408333333) (radius r) (material diel))

	(make sphere (center -0.3466666667 0.2733333333 -0.0591666667) (radius r) (material diel))

	(make sphere (center -0.1066666667 -0.0366666667 -0.0591666667) (radius r) (material diel))

	(make sphere (center 0.2033333333 0.5133333333 -0.0591666667) (radius r) (material diel))

	(make sphere (center -0.0366666667 -0.4166666667 -0.2291666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.0366666667 -0.2291666667) (radius r) (material diel))

	(make sphere (center 0.2033333333 0.2033333333 -0.2291666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 0.2033333333 0.2708333333) (radius r) (material diel))

	(make sphere (center -0.0366666667 -0.0366666667 0.2708333333) (radius r) (material diel))

	(make sphere (center 0.2033333333 -0.4166666667 0.2708333333) (radius r) (material diel))
))
