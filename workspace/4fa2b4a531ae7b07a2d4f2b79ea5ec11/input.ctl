...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.80402703) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.804027033)))
...
(set! geometry (list (make sphere (center -0.45 -0.45 -0.25) (radius r) (material diel))

	(make sphere (center -0.45 -0.45 0.25) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 0.4598) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 0.0402) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 -0.4598) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 -0.0402) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 -0.25) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 0.25) (radius r) (material diel))

	(make sphere (center -0.13154 0.50261 -0.36983) (radius r) (material diel))

	(make sphere (center -0.40261 -0.08415 -0.36983) (radius r) (material diel))

	(make sphere (center 0.18415 0.23154 -0.36983) (radius r) (material diel))

	(make sphere (center -0.40261 0.23154 -0.13017) (radius r) (material diel))

	(make sphere (center -0.13154 -0.08415 -0.13017) (radius r) (material diel))

	(make sphere (center 0.18415 0.50261 -0.13017) (radius r) (material diel))

	(make sphere (center 0.23154 -0.40261 0.36983) (radius r) (material diel))

	(make sphere (center 0.50261 0.18415 0.36983) (radius r) (material diel))

	(make sphere (center -0.08415 -0.13154 0.36983) (radius r) (material diel))

	(make sphere (center 0.50261 -0.13154 0.13017) (radius r) (material diel))

	(make sphere (center 0.23154 0.18415 0.13017) (radius r) (material diel))

	(make sphere (center -0.08415 -0.40261 0.13017) (radius r) (material diel))
))
