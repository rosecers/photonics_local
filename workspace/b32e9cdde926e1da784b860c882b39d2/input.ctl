...
(set! geometry-lattice (make lattice (basis-size 1.0 0.70565548 0.9820051) (basis1 1.0 0.0 0.0) (basis2 0.0 0.7056554785 0.0) (basis3 0.0 0.0 0.9820050977)))
...
(set! geometry (list (make sphere (center 0.25 0.0 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.75 0.0 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.5 0.25 0.5) (radius r) (material diel))
