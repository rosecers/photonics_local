...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.08788121) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0878812076)))
...
(set! geometry (list (make sphere (center 0.16666666666666666 -0.3333333333333333 -0.4) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 0.16666666666666666 -0.4) (radius r) (material diel))

	(make sphere (center 0.16666666666666666 0.16666666666666666 -0.4) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 -0.3333333333333333 -0.1614) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 -0.3333333333333333 0.3614) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.0 0.1) (radius r) (material diel))

	(make sphere (center 0.0 0.3333333333333333 0.1) (radius r) (material diel))

	(make sphere (center 0.2986666666666667 -0.3333333333333333 0.297) (radius r) (material diel))

	(make sphere (center 0.034666666666666665 -0.3333333333333333 -0.097) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 0.2986666666666667 0.297) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 0.034666666666666665 -0.097) (radius r) (material diel))

	(make sphere (center 0.034666666666666665 0.034666666666666665 0.297) (radius r) (material diel))

	(make sphere (center 0.2986666666666667 0.2986666666666667 -0.097) (radius r) (material diel))
