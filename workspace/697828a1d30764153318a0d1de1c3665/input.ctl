...
(set! geometry (list (make sphere (center 0.0375 -0.4625 0.0375) (radius r) (material diel))

	(make sphere (center 0.0375 0.0375 0.0375) (radius r) (material diel))

	(make sphere (center -0.4625 0.0375 0.0375) (radius r) (material diel))

	(make sphere (center 0.0375 0.0375 -0.4625) (radius r) (material diel))

	(make sphere (center -0.3375 -0.3375 -0.3375) (radius r) (material diel))

	(make sphere (center -0.5875 -0.5875 -0.5875) (radius r) (material diel))

	(make sphere (center -0.0875 -0.0875 -0.0875) (radius r) (material diel))

	(make sphere (center 0.1625 0.1625 0.1625) (radius r) (material diel))

	(make sphere (center -0.1805 0.1915 -0.1805) (radius r) (material diel))

	(make sphere (center 0.2555 -0.1165 0.2555) (radius r) (material diel))

	(make sphere (center -0.1805 -0.1805 -0.1805) (radius r) (material diel))

	(make sphere (center 0.2555 0.2555 0.2555) (radius r) (material diel))

	(make sphere (center 0.1915 -0.1805 -0.1805) (radius r) (material diel))

	(make sphere (center -0.1165 0.2555 0.2555) (radius r) (material diel))

	(make sphere (center -0.1805 -0.1805 0.1915) (radius r) (material diel))

	(make sphere (center 0.2555 0.2555 -0.1165) (radius r) (material diel))

	(make sphere (center -0.3345 0.0435 -0.3345) (radius r) (material diel))

	(make sphere (center 0.4095 0.0315 0.4095) (radius r) (material diel))

	(make sphere (center -0.3345 0.2755 -0.3345) (radius r) (material diel))

	(make sphere (center 0.4095 -0.2005 0.4095) (radius r) (material diel))

	(make sphere (center 0.0435 -0.3345 0.2755) (radius r) (material diel))

	(make sphere (center 0.0315 0.4095 -0.2005) (radius r) (material diel))

	(make sphere (center 0.2755 -0.3345 0.0435) (radius r) (material diel))

	(make sphere (center -0.2005 0.4095 0.0315) (radius r) (material diel))

	(make sphere (center -0.3345 0.0435 0.2755) (radius r) (material diel))

	(make sphere (center 0.4095 0.0315 -0.2005) (radius r) (material diel))

	(make sphere (center -0.3345 0.2755 0.0435) (radius r) (material diel))

	(make sphere (center 0.4095 -0.2005 0.0315) (radius r) (material diel))

	(make sphere (center 0.2755 -0.3345 -0.3345) (radius r) (material diel))

	(make sphere (center -0.2005 0.4095 0.4095) (radius r) (material diel))

	(make sphere (center 0.0435 -0.3345 -0.3345) (radius r) (material diel))

	(make sphere (center 0.0315 0.4095 0.4095) (radius r) (material diel))

	(make sphere (center 0.2755 0.0435 -0.3345) (radius r) (material diel))

	(make sphere (center -0.2005 0.0315 0.4095) (radius r) (material diel))

	(make sphere (center 0.0435 0.2755 -0.3345) (radius r) (material diel))

	(make sphere (center 0.0315 -0.2005 0.4095) (radius r) (material diel))

	(make sphere (center -0.3345 -0.3345 0.0435) (radius r) (material diel))

	(make sphere (center 0.4095 0.4095 0.0315) (radius r) (material diel))

	(make sphere (center -0.3345 -0.3345 0.2755) (radius r) (material diel))

	(make sphere (center 0.4095 0.4095 -0.2005) (radius r) (material diel))
))
