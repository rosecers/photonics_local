...
(set! geometry (list (make sphere (center -0.3666666667 -0.3666666667 -0.3666666667) (radius r) (material diel))

	(make sphere (center -0.3666666667 0.1333333333 -0.3666666667) (radius r) (material diel))

	(make sphere (center 0.1333333333 -0.3666666667 0.1333333333) (radius r) (material diel))

	(make sphere (center -0.3666666667 0.1333333333 0.1333333333) (radius r) (material diel))

	(make sphere (center 0.1333333333 -0.3666666667 -0.3666666667) (radius r) (material diel))

	(make sphere (center 0.1333333333 0.1333333333 -0.3666666667) (radius r) (material diel))

	(make sphere (center -0.3666666667 -0.3666666667 0.1333333333) (radius r) (material diel))

	(make sphere (center 0.4883333333 0.0683333333 0.4883333333) (radius r) (material diel))

	(make sphere (center -0.2216666667 0.1983333333 -0.2216666667) (radius r) (material diel))

	(make sphere (center 0.4883333333 0.4883333333 0.4883333333) (radius r) (material diel))

	(make sphere (center -0.2216666667 -0.2216666667 -0.2216666667) (radius r) (material diel))

	(make sphere (center 0.0683333333 0.4883333333 0.4883333333) (radius r) (material diel))

	(make sphere (center 0.1983333333 -0.2216666667 -0.2216666667) (radius r) (material diel))

	(make sphere (center 0.4883333333 0.4883333333 0.0683333333) (radius r) (material diel))

	(make sphere (center -0.2216666667 -0.2216666667 0.1983333333) (radius r) (material diel))
))
