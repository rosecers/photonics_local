...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.01958966) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0195896636)))
...
(set! geometry (list (make sphere (center 0.7194 0.0 0.5765) (radius r) (material diel))

	(make sphere (center 0.0 0.7194 0.5765) (radius r) (material diel))

	(make sphere (center 0.2806 0.2806 0.5765) (radius r) (material diel))

	(make sphere (center 0.2806 0.0 0.0765) (radius r) (material diel))

	(make sphere (center 0.0 0.2806 0.0765) (radius r) (material diel))

	(make sphere (center 0.7194 0.7194 0.0765) (radius r) (material diel))

	(make sphere (center 0.6239 0.0 0.9246) (radius r) (material diel))

	(make sphere (center 0.0 0.6239 0.9246) (radius r) (material diel))

	(make sphere (center 0.3761 0.3761 0.9246) (radius r) (material diel))

	(make sphere (center 0.3761 0.0 0.4246) (radius r) (material diel))

	(make sphere (center 0.0 0.3761 0.4246) (radius r) (material diel))

	(make sphere (center 0.6239 0.6239 0.4246) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.6998) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.1998) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.1998) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.6998) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.8213) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.3213) (radius r) (material diel))

	(make sphere (center 0.6678 0.0 0.25) (radius r) (material diel))

	(make sphere (center 0.0 0.6678 0.25) (radius r) (material diel))

	(make sphere (center 0.3322 0.3322 0.25) (radius r) (material diel))

	(make sphere (center 0.3322 0.0 0.75) (radius r) (material diel))

	(make sphere (center 0.0 0.3322 0.75) (radius r) (material diel))

	(make sphere (center 0.6678 0.6678 0.75) (radius r) (material diel))
))
