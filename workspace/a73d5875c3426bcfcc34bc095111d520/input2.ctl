...
(set! geometry (list (make sphere (center -0.21875 0.28125 -0.21875) (radius r) (material diel))
	...
	(make sphere (center 0.09125 -0.27875 -0.27875) (radius r) (material diel))
	...
	(make sphere (center 0.09125 0.09125 -0.27875) (radius r) (material diel))

	(make sphere (center 0.47125 -0.15875 0.47125) (radius r) (material diel))

	(make sphere (center 0.09125 -0.27875 0.09125) (radius r) (material diel))
