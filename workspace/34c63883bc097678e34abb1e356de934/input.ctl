...
(set! geometry (list (make sphere (center 0.0517241379 0.0517241379 0.0517241379) (radius r) (material diel))

	(make sphere (center -0.4482758621 0.0517241379 0.0517241379) (radius r) (material diel))

	(make sphere (center 0.0517241379 -0.4482758621 -0.4482758621) (radius r) (material diel))

	(make sphere (center 0.0517241379 0.0517241379 -0.4482758621) (radius r) (material diel))

	(make sphere (center -0.4482758621 -0.4482758621 0.0517241379) (radius r) (material diel))

	(make sphere (center -0.4482758621 0.0517241379 -0.4482758621) (radius r) (material diel))

	(make sphere (center 0.0517241379 -0.4482758621 0.0517241379) (radius r) (material diel))

	(make sphere (center 0.3527241379 -0.2492758621 -0.2492758621) (radius r) (material diel))

	(make sphere (center -0.2492758621 0.3527241379 0.3527241379) (radius r) (material diel))

	(make sphere (center -0.2492758621 -0.2492758621 0.3527241379) (radius r) (material diel))

	(make sphere (center 0.3527241379 0.3527241379 -0.2492758621) (radius r) (material diel))

	(make sphere (center 0.3527241379 -0.2492758621 0.3527241379) (radius r) (material diel))

	(make sphere (center -0.2492758621 0.3527241379 -0.2492758621) (radius r) (material diel))

	(make sphere (center 0.3867241379 0.0467241379 0.3867241379) (radius r) (material diel))

	(make sphere (center -0.2832758621 0.0567241379 -0.2832758621) (radius r) (material diel))

	(make sphere (center 0.3867241379 0.3867241379 0.3867241379) (radius r) (material diel))

	(make sphere (center -0.2832758621 -0.2832758621 -0.2832758621) (radius r) (material diel))

	(make sphere (center 0.0467241379 0.3867241379 0.3867241379) (radius r) (material diel))

	(make sphere (center 0.0567241379 -0.2832758621 -0.2832758621) (radius r) (material diel))

	(make sphere (center 0.3867241379 0.3867241379 0.0467241379) (radius r) (material diel))

	(make sphere (center -0.2832758621 -0.2832758621 0.0567241379) (radius r) (material diel))

	(make sphere (center 0.1707241379 -0.3052758621 0.1707241379) (radius r) (material diel))

	(make sphere (center -0.0672758621 0.4087241379 -0.0672758621) (radius r) (material diel))

	(make sphere (center 0.1707241379 0.1707241379 0.1707241379) (radius r) (material diel))

	(make sphere (center -0.0672758621 -0.0672758621 -0.0672758621) (radius r) (material diel))

	(make sphere (center -0.3052758621 0.1707241379 0.1707241379) (radius r) (material diel))

	(make sphere (center 0.4087241379 -0.0672758621 -0.0672758621) (radius r) (material diel))

	(make sphere (center 0.1707241379 0.1707241379 -0.3052758621) (radius r) (material diel))

	(make sphere (center -0.0672758621 -0.0672758621 0.4087241379) (radius r) (material diel))
))
