...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.96715818) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.9671581832)))
...
(set! geometry (list (make sphere (center -0.0566666667 -0.3766666667 -0.3541666667) (radius r) (material diel))

	(make sphere (center 0.5433333333 -0.0966666667 -0.3541666667) (radius r) (material diel))

	(make sphere (center 0.2633333333 0.2233333333 -0.3541666667) (radius r) (material diel))

	(make sphere (center -0.0566666667 -0.3766666667 -0.1041666667) (radius r) (material diel))

	(make sphere (center 0.5433333333 -0.0966666667 -0.1041666667) (radius r) (material diel))

	(make sphere (center 0.2633333333 0.2233333333 -0.1041666667) (radius r) (material diel))

	(make sphere (center -0.3766666667 -0.0566666667 0.1458333333) (radius r) (material diel))

	(make sphere (center -0.0966666667 0.5433333333 0.1458333333) (radius r) (material diel))

	(make sphere (center 0.2233333333 0.2633333333 0.1458333333) (radius r) (material diel))

	(make sphere (center -0.3766666667 -0.0566666667 0.3958333333) (radius r) (material diel))

	(make sphere (center -0.0966666667 0.5433333333 0.3958333333) (radius r) (material diel))

	(make sphere (center 0.2233333333 0.2633333333 0.3958333333) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 -0.4791666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 0.0208333333) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.4631666667) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 0.0048333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.0368333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.5048333333) (radius r) (material diel))

	(make sphere (center 0.2500000033 -0.4166666667 -0.2291666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 0.2500000033 -0.2291666667) (radius r) (material diel))

	(make sphere (center -0.0833333367 -0.0833333367 -0.2291666667) (radius r) (material diel))

	(make sphere (center -0.4166666667 0.2500000033 0.2708333333) (radius r) (material diel))

	(make sphere (center 0.2500000033 -0.4166666667 0.2708333333) (radius r) (material diel))

	(make sphere (center -0.0833333367 -0.0833333367 0.2708333333) (radius r) (material diel))
))
