...
(set! geometry (list (make sphere (center -0.4285714286 -0.4285714286 -0.4285714286) (radius r) (material diel))

	(make sphere (center -0.1785714286 0.3214285714 0.0714285714) (radius r) (material diel))

	(make sphere (center 0.3214285714 -0.1785714286 0.0714285714) (radius r) (material diel))

	(make sphere (center 0.3214285714 0.0714285714 -0.1785714286) (radius r) (material diel))

	(make sphere (center -0.1785714286 0.0714285714 0.3214285714) (radius r) (material diel))

	(make sphere (center 0.0714285714 0.3214285714 -0.1785714286) (radius r) (material diel))

	(make sphere (center 0.0714285714 -0.1785714286 0.3214285714) (radius r) (material diel))
))
