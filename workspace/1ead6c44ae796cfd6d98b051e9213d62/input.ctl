(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.77480211) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.7748021148)))
...
(set! geometry (list (make sphere (center 0.0 0.0 0.25) (radius r) (material diel))
	...
	(make sphere (center 0.3333333333333333 0.6666666666666666 0.5806166666666667) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.41938333333333333) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.08061666666666667) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.9193833333333333) (radius r) (material diel))
