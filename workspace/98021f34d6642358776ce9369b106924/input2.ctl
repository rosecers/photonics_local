...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 7.21393039) (basis1 0.8660254038 -0.5 0.0) (basis2 0.8660254038 0.5 0.0) (basis3 0.0 0.0 7.2139303929)))
...
(set! geometry (list (make sphere (center -0.3333333333 -0.3333333333 0.0) (radius r) (material diel))

	(make sphere (center 0.3336666667 0.3336666667 0.333) (radius r) (material diel))

	(make sphere (center -0.0003333333 -0.0003333333 -0.333) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 0.222) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 -0.222) (radius r) (material diel))

	(make sphere (center 0.3336666667 0.3336666667 -0.445) (radius r) (material diel))

	(make sphere (center 0.3336666667 0.3336666667 0.111) (radius r) (material diel))

	(make sphere (center -0.0003333333 -0.0003333333 -0.111) (radius r) (material diel))

	(make sphere (center -0.0003333333 -0.0003333333 0.445) (radius r) (material diel))
))
