...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.36839833) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.3683983322)))
...
(set! geometry (list (make sphere (center -0.0007333333 -0.3333333333 -0.0567055556) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.0007333333 -0.0567055556) (radius r) (material diel))

	(make sphere (center 0.3340666667 0.3340666667 -0.0567055556) (radius r) (material diel))

	(make sphere (center -0.0 0.3333333333 -0.4376055556) (radius r) (material diel))

	(make sphere (center 0.3333333333 0.0 -0.4376055556) (radius r) (material diel))

	(make sphere (center 0.5006666667 -0.3333333333 0.1299944444) (radius r) (material diel))

	(make sphere (center -0.3333333333 0.5006666667 0.1299944444) (radius r) (material diel))

	(make sphere (center -0.1673333333 -0.1673333333 0.1299944444) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 -0.3630055556) (radius r) (material diel))

	(make sphere (center -0.0 0.3333333333 -0.2192055556) (radius r) (material diel))

	(make sphere (center 0.3333333333 0.0 -0.2192055556) (radius r) (material diel))

	(make sphere (center 0.1726666667 -0.3333333333 0.4804944444) (radius r) (material diel))

	(make sphere (center -0.3333333333 0.1726666667 0.4804944444) (radius r) (material diel))

	(make sphere (center 0.1606666667 0.1606666667 0.4804944444) (radius r) (material diel))

	(make sphere (center 0.3322666667 -0.3333333333 0.0760944444) (radius r) (material diel))

	(make sphere (center -0.3333333333 0.3322666667 0.0760944444) (radius r) (material diel))

	(make sphere (center 0.0010666667 0.0010666667 0.0760944444) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 -0.2130055556) (radius r) (material diel))
))
