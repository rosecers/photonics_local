...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.50159281) (basis1 1.0 0.0 0.0) (basis2 -0.5000000000072401 0.8660254037930367 0.0) (basis3 0.0 0.0 0.5015928059269197)))
...
(set! geometry (list (make sphere (center 0.5925 0.0 0.5) (radius r) (material diel))

	(make sphere (center 0.0 0.5925 0.5) (radius r) (material diel))

	(make sphere (center 0.4075 0.4075 0.5) (radius r) (material diel))
	...
	(make sphere (center 0.2505 0.0 0.0) (radius r) (material diel))

	(make sphere (center 0.0 0.2505 0.0) (radius r) (material diel))

	(make sphere (center 0.7495 0.7495 0.0) (radius r) (material diel))
))
