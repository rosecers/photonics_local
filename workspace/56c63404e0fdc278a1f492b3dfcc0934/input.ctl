...
(set! geometry (list (make sphere (center -0.4583333333 -0.4583333333 -0.451) (radius r) (material diel))
	...
	(make sphere (center 0.3286666667 -0.1853333333 -0.217) (radius r) (material diel))

	(make sphere (center -0.2453333333 0.2686666667 0.217) (radius r) (material diel))

	(make sphere (center 0.4816666667 0.3286666667 -0.217) (radius r) (material diel))

	(make sphere (center -0.3983333333 -0.2453333333 0.217) (radius r) (material diel))

	(make sphere (center -0.1853333333 0.4816666667 -0.217) (radius r) (material diel))

	(make sphere (center 0.2686666667 -0.3983333333 0.217) (radius r) (material diel))

	(make sphere (center 0.2686666667 -0.2453333333 -0.283) (radius r) (material diel))

	(make sphere (center -0.1853333333 0.3286666667 0.283) (radius r) (material diel))

	(make sphere (center -0.2453333333 -0.3983333333 -0.283) (radius r) (material diel))

	(make sphere (center 0.3286666667 0.4816666667 0.283) (radius r) (material diel))

	(make sphere (center -0.3983333333 0.2686666667 -0.283) (radius r) (material diel))

	(make sphere (center 0.4816666667 -0.1853333333 0.283) (radius r) (material diel))

	(make sphere (center -0.0043333333 0.4816666667 0.116) (radius r) (material diel))

	(make sphere (center 0.4206666667 -0.0643333333 -0.449) (radius r) (material diel))

	(make sphere (center 0.1476666667 -0.0043333333 0.116) (radius r) (material diel))

	(make sphere (center 0.2686666667 0.4206666667 -0.449) (radius r) (material diel))

	(make sphere (center 0.4816666667 0.1476666667 0.116) (radius r) (material diel))

	(make sphere (center -0.0643333333 0.2686666667 -0.449) (radius r) (material diel))

	(make sphere (center -0.0643333333 0.4206666667 0.051) (radius r) (material diel))

	(make sphere (center 0.4816666667 -0.0043333333 -0.384) (radius r) (material diel))

	(make sphere (center 0.4206666667 0.2686666667 0.051) (radius r) (material diel))

	(make sphere (center -0.0043333333 0.1476666667 -0.384) (radius r) (material diel))

	(make sphere (center 0.2686666667 -0.0643333333 0.051) (radius r) (material diel))

	(make sphere (center 0.1476666667 0.4816666667 -0.384) (radius r) (material diel))

	(make sphere (center -0.3373333333 0.1476666667 0.449) (radius r) (material diel))

	(make sphere (center 0.0876666667 -0.3983333333 -0.116) (radius r) (material diel))

	(make sphere (center -0.1853333333 -0.3373333333 0.449) (radius r) (material diel))

	(make sphere (center -0.0643333333 0.0876666667 -0.116) (radius r) (material diel))

	(make sphere (center 0.1476666667 -0.1853333333 0.449) (radius r) (material diel))

	(make sphere (center -0.3983333333 -0.0643333333 -0.116) (radius r) (material diel))

	(make sphere (center -0.3983333333 0.0876666667 0.384) (radius r) (material diel))

	(make sphere (center 0.1476666667 -0.3373333333 -0.051) (radius r) (material diel))

	(make sphere (center 0.0876666667 -0.0643333333 0.384) (radius r) (material diel))

	(make sphere (center -0.3373333333 -0.1853333333 -0.051) (radius r) (material diel))

	(make sphere (center -0.0643333333 -0.3983333333 0.384) (radius r) (material diel))

	(make sphere (center -0.1853333333 0.1476666667 -0.051) (radius r) (material diel))
))
