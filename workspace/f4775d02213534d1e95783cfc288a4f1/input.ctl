(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.66533865) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.6653386544)))
...
(set! geometry (list (make sphere (center 0.0833333333 0.4166666667 -0.325) (radius r) (material diel))

	(make sphere (center 0.4166666667 0.0833333333 0.575) (radius r) (material diel))
