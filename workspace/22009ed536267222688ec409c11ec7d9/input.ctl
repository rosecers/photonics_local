(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.06918729) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0691872918)))
...
(set! geometry (list (make sphere (center 0.0 0.3333333333 0.3919388889) (radius r) (material diel))

	(make sphere (center 0.3333333333 0.0 0.3919388889) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 -0.1079111111) (radius r) (material diel))

	(make sphere (center 0.0406666667 0.0406666667 -0.4146611111) (radius r) (material diel))

	(make sphere (center 0.2926666667 -0.3333333333 -0.4146611111) (radius r) (material diel))

	(make sphere (center -0.3333333333 0.2926666667 -0.4146611111) (radius r) (material diel))

	(make sphere (center -0.3333333333 0.0516666617 0.1893388889) (radius r) (material diel))

	(make sphere (center 0.2816666717 0.2816666717 0.1893388889) (radius r) (material diel))

	(make sphere (center 0.0516666617 -0.3333333333 0.1893388889) (radius r) (material diel))
))
