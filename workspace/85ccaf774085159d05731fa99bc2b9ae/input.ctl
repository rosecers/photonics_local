...
(set! geometry (list (make sphere (center -0.062 -0.062 -0.45) (radius r) (material diel))

	(make sphere (center 0.262 0.262 -0.45) (radius r) (material diel))

	(make sphere (center -0.062 -0.4 -0.112) (radius r) (material diel))

	(make sphere (center 0.262 -0.4 0.212) (radius r) (material diel))

	(make sphere (center -0.4 0.262 0.212) (radius r) (material diel))

	(make sphere (center -0.4 -0.062 -0.112) (radius r) (material diel))

	(make sphere (center -0.15 0.35 0.05) (radius r) (material diel))

	(make sphere (center 0.35 -0.15 0.05) (radius r) (material diel))

	(make sphere (center 0.35 0.1 -0.2) (radius r) (material diel))

	(make sphere (center -0.15 0.1 0.3) (radius r) (material diel))

	(make sphere (center 0.1 0.35 -0.2) (radius r) (material diel))

	(make sphere (center 0.1 -0.15 0.3) (radius r) (material diel))

	(make sphere (center -0.064 0.6 0.55) (radius r) (material diel))

	(make sphere (center 0.264 -0.4 -0.45) (radius r) (material diel))

	(make sphere (center 0.264 0.264 0.214) (radius r) (material diel))

	(make sphere (center -0.064 -0.064 -0.114) (radius r) (material diel))

	(make sphere (center -0.4 -0.4 -0.114) (radius r) (material diel))

	(make sphere (center 0.6 -0.4 0.214) (radius r) (material diel))

	(make sphere (center -0.4 -0.064 -0.45) (radius r) (material diel))

	(make sphere (center -0.4 0.264 0.55) (radius r) (material diel))
))
