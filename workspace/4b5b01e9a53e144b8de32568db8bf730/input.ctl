(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.32534387) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.3253438672)))
...
(set! geometry (list (make sphere (center 0.0 0.0 0.16) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.84) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.66) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.34) (radius r) (material diel))

	(make sphere (center 0.333333 0.666667 0.25) (radius r) (material diel))

	(make sphere (center 0.666667 0.333333 0.75) (radius r) (material diel))

	(make sphere (center 0.3472 0.9956 0.25) (radius r) (material diel))

	(make sphere (center 0.6528 0.0044 0.75) (radius r) (material diel))

	(make sphere (center 0.0044 0.3516 0.25) (radius r) (material diel))

	(make sphere (center 0.9956 0.6484 0.75) (radius r) (material diel))

	(make sphere (center 0.6484 0.6528 0.25) (radius r) (material diel))

	(make sphere (center 0.3516 0.3472 0.75) (radius r) (material diel))

	(make sphere (center 0.1935 0.3048 0.25) (radius r) (material diel))

	(make sphere (center 0.8065 0.6952 0.75) (radius r) (material diel))

	(make sphere (center 0.6952 0.8887 0.25) (radius r) (material diel))

	(make sphere (center 0.3048 0.1113 0.75) (radius r) (material diel))

	(make sphere (center 0.1113 0.8065 0.25) (radius r) (material diel))

	(make sphere (center 0.8887 0.1935 0.75) (radius r) (material diel))

	(make sphere (center 0.5316 0.3985 0.25) (radius r) (material diel))

	(make sphere (center 0.4684 0.6015 0.75) (radius r) (material diel))

	(make sphere (center 0.6015 0.1331 0.25) (radius r) (material diel))

	(make sphere (center 0.3985 0.8669 0.75) (radius r) (material diel))

	(make sphere (center 0.8669 0.4684 0.25) (radius r) (material diel))

	(make sphere (center 0.1331 0.5316 0.75) (radius r) (material diel))
))
