...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.10761055) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.1076105535)))
...
(set! geometry (list (make sphere (center -0.380952381 -0.380952381 0.2142857143) (radius r) (material diel))

	(make sphere (center -0.380952381 -0.380952381 -0.4523809524) (radius r) (material diel))

	(make sphere (center -0.380952381 -0.380952381 -0.119047619) (radius r) (material diel))

	(make sphere (center 0.119047619 0.119047619 -0.2857142857) (radius r) (material diel))

	(make sphere (center 0.119047619 -0.380952381 0.0476190476) (radius r) (material diel))

	(make sphere (center -0.380952381 0.119047619 0.380952381) (radius r) (material diel))

	(make sphere (center 0.119047619 0.119047619 0.2142857143) (radius r) (material diel))

	(make sphere (center 0.119047619 -0.380952381 -0.4523809524) (radius r) (material diel))

	(make sphere (center -0.380952381 0.119047619 -0.119047619) (radius r) (material diel))

	(make sphere (center -0.170452381 0.424947619 0.4686857176) (radius r) (material diel))

	(make sphere (center -0.186852381 0.023647619 -0.197980949) (radius r) (material diel))

	(make sphere (center 0.214447619 0.408547619 0.1353523843) (radius r) (material diel))

	(make sphere (center 0.408547619 -0.186852381 0.4686857176) (radius r) (material diel))

	(make sphere (center 0.424947619 0.214447619 -0.197980949) (radius r) (material diel))

	(make sphere (center 0.023647619 -0.170452381 0.1353523843) (radius r) (material diel))

	(make sphere (center 0.424947619 -0.170452381 -0.040114289) (radius r) (material diel))

	(make sphere (center 0.023647619 -0.186852381 -0.3734476224) (radius r) (material diel))

	(make sphere (center 0.408547619 0.214447619 0.2932190443) (radius r) (material diel))

	(make sphere (center -0.186852381 0.408547619 -0.040114289) (radius r) (material diel))

	(make sphere (center 0.214447619 0.424947619 -0.3734476224) (radius r) (material diel))

	(make sphere (center -0.170452381 0.023647619 0.2932190443) (radius r) (material diel))
))
