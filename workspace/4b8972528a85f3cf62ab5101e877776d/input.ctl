...
(set! geometry (list (make sphere (center -0.2445652174 -0.2445652174 -0.2445652174) (radius r) (material diel))

	(make sphere (center -0.4945652174 -0.4945652174 -0.4945652174) (radius r) (material diel))

	(make sphere (center 0.1304347826 -0.3695652174 0.1304347826) (radius r) (material diel))

	(make sphere (center 0.1304347826 0.1304347826 0.1304347826) (radius r) (material diel))

	(make sphere (center 0.1304347826 0.1304347826 -0.3695652174) (radius r) (material diel))

	(make sphere (center -0.3695652174 0.1304347826 0.1304347826) (radius r) (material diel))

	(make sphere (center -0.0435652174 -0.3135652174 -0.0435652174) (radius r) (material diel))

	(make sphere (center 0.3044347826 -0.4255652174 0.3044347826) (radius r) (material diel))

	(make sphere (center -0.0435652174 0.4224347826 -0.0435652174) (radius r) (material diel))

	(make sphere (center 0.3044347826 -0.1615652174 0.3044347826) (radius r) (material diel))

	(make sphere (center 0.4224347826 -0.0435652174 -0.3135652174) (radius r) (material diel))

	(make sphere (center -0.1615652174 0.3044347826 -0.4255652174) (radius r) (material diel))

	(make sphere (center -0.3135652174 -0.0435652174 0.4224347826) (radius r) (material diel))

	(make sphere (center -0.4255652174 0.3044347826 -0.1615652174) (radius r) (material diel))

	(make sphere (center 0.4224347826 -0.3135652174 -0.0435652174) (radius r) (material diel))

	(make sphere (center -0.1615652174 -0.4255652174 0.3044347826) (radius r) (material diel))

	(make sphere (center -0.3135652174 0.4224347826 -0.0435652174) (radius r) (material diel))

	(make sphere (center -0.4255652174 -0.1615652174 0.3044347826) (radius r) (material diel))

	(make sphere (center -0.0435652174 -0.0435652174 0.4224347826) (radius r) (material diel))

	(make sphere (center 0.3044347826 0.3044347826 -0.1615652174) (radius r) (material diel))

	(make sphere (center -0.0435652174 -0.0435652174 -0.3135652174) (radius r) (material diel))

	(make sphere (center 0.3044347826 0.3044347826 -0.4255652174) (radius r) (material diel))

	(make sphere (center -0.0435652174 -0.3135652174 0.4224347826) (radius r) (material diel))

	(make sphere (center 0.3044347826 -0.4255652174 -0.1615652174) (radius r) (material diel))

	(make sphere (center -0.0435652174 0.4224347826 -0.3135652174) (radius r) (material diel))

	(make sphere (center 0.3044347826 -0.1615652174 -0.4255652174) (radius r) (material diel))

	(make sphere (center -0.3135652174 -0.0435652174 -0.0435652174) (radius r) (material diel))

	(make sphere (center -0.4255652174 0.3044347826 0.3044347826) (radius r) (material diel))

	(make sphere (center 0.4224347826 -0.0435652174 -0.0435652174) (radius r) (material diel))

	(make sphere (center -0.1615652174 0.3044347826 0.3044347826) (radius r) (material diel))

	(make sphere (center 0.3924347826 0.3924347826 0.1184347826) (radius r) (material diel))

	(make sphere (center -0.1315652174 -0.1315652174 0.1424347826) (radius r) (material diel))

	(make sphere (center 0.1184347826 0.1184347826 0.3924347826) (radius r) (material diel))

	(make sphere (center 0.1424347826 0.1424347826 -0.1315652174) (radius r) (material diel))

	(make sphere (center 0.1184347826 0.3924347826 0.3924347826) (radius r) (material diel))

	(make sphere (center 0.1424347826 -0.1315652174 -0.1315652174) (radius r) (material diel))

	(make sphere (center 0.3924347826 0.1184347826 0.1184347826) (radius r) (material diel))

	(make sphere (center -0.1315652174 0.1424347826 0.1424347826) (radius r) (material diel))

	(make sphere (center 0.1184347826 0.3924347826 0.1184347826) (radius r) (material diel))

	(make sphere (center 0.1424347826 -0.1315652174 0.1424347826) (radius r) (material diel))

	(make sphere (center 0.3924347826 0.1184347826 0.3924347826) (radius r) (material diel))

	(make sphere (center -0.1315652174 0.1424347826 -0.1315652174) (radius r) (material diel))

	(make sphere (center -0.3695652174 0.1304347826 -0.3695652174) (radius r) (material diel))

	(make sphere (center -0.3695652174 -0.3695652174 -0.3695652174) (radius r) (material diel))

	(make sphere (center -0.3695652174 -0.3695652174 0.1304347826) (radius r) (material diel))

	(make sphere (center 0.1304347826 -0.3695652174 -0.3695652174) (radius r) (material diel))
))
