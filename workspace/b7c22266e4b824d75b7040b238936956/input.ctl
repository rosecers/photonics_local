...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.63730856) (basis1 0.5 -0.8660254038 0.0) (basis2 0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.6373085616)))
...
(set! geometry (list (make sphere (center -0.3333333333 -0.3333333333 0.3333333333) (radius r) (material diel))
	...
	(make sphere (center -0.0003333333 0.3336666667 -0.1666666667) (radius r) (material diel))

	(make sphere (center 0.3336666667 -0.0003333333 -0.1666666667) (radius r) (material diel))
))
