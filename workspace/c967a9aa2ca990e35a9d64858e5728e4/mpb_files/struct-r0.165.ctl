...
(set! geometry (list (make sphere (center 0.165 0.33896 0.50805) (radius r) (material diel))
	...
	(make sphere (center 0.165 0.67429 0.00781) (radius r) (material diel))
	...
	(make sphere (center 0.165 0.6778 0.3619) (radius r) (material diel))
	(make sphere (center 0.5 0.3222 0.8619) (radius r) (material diel))
	(make sphere (center 0.5 0.6394 0.3949) (radius r) (material diel))
	(make sphere (center 0.165 0.3606 0.8949) (radius r) (material diel))
))
