...
(set! geometry (list (make sphere (center 0.2857142857 -0.3608571429 -0.4208571429) (radius r) (material diel))
	...
	(make sphere (center 0.12897142857 0.3141428571 -0.0298571429) (radius r) (material diel))
	...
	(make sphere (center 0.12917142857 -0.0118571429 -0.3938571429) (radius r) (material diel))
	...
	(make sphere (center 0.12357142857 0.2501428571 0.2501428571) (radius r) (material diel))
