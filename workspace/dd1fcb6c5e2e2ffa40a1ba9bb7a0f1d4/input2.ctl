...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.92531949) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.9253194932)))
...
(set! geometry (list (make sphere (center -0.1111111111 0.2222222222 -0.2222222222) (radius r) (material diel))

	(make sphere (center 0.2222222222 -0.1111111111 0.2777777778) (radius r) (material diel))

	(make sphere (center -0.4444444444 -0.4444444444 -0.4722222222) (radius r) (material diel))

	(make sphere (center -0.4444444444 -0.4444444444 0.0277777778) (radius r) (material diel))

	(make sphere (center 0.2222222222 -0.1111111111 -0.2222222222) (radius r) (material diel))

	(make sphere (center -0.1111111111 0.2222222222 0.2777777778) (radius r) (material diel))

	(make sphere (center -0.0676444411 -0.4134444478 -0.3288222222) (radius r) (material diel))

	(make sphere (center -0.0986444378 0.5245555589 0.1711777778) (radius r) (material diel))

	(make sphere (center -0.4134444478 0.2097555489 0.3843777778) (radius r) (material diel))

	(make sphere (center 0.5245555589 0.1787555522 -0.1156222222) (radius r) (material diel))

	(make sphere (center 0.2097555489 0.1787555522 -0.3288222222) (radius r) (material diel))

	(make sphere (center 0.1787555522 0.2097555489 0.1711777778) (radius r) (material diel))

	(make sphere (center 0.1787555522 0.5245555589 0.3843777778) (radius r) (material diel))

	(make sphere (center 0.2097555489 -0.4134444478 -0.1156222222) (radius r) (material diel))

	(make sphere (center 0.5245555589 -0.0986444378 -0.3288222222) (radius r) (material diel))

	(make sphere (center -0.4134444478 -0.0676444411 0.1711777778) (radius r) (material diel))

	(make sphere (center -0.0986444378 -0.0676444411 0.3843777778) (radius r) (material diel))

	(make sphere (center -0.0676444411 -0.0986444378 -0.1156222222) (radius r) (material diel))
))
