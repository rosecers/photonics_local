...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.5132172) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.5132172007)))
...
(set! geometry (list (make sphere (center 0.21274 0.4255 0.0) (radius r) (material diel))

	(make sphere (center 0.78726 0.5745 0.0) (radius r) (material diel))

	(make sphere (center 0.5745 0.78724 0.0) (radius r) (material diel))

	(make sphere (center 0.4255 0.21276 0.0) (radius r) (material diel))

	(make sphere (center 0.21276 0.78726 0.0) (radius r) (material diel))

	(make sphere (center 0.78724 0.21274 0.0) (radius r) (material diel))
