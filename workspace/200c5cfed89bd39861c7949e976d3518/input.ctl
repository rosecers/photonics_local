(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.45638126) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.4563812624)))
...
(set! geometry (list (make sphere (center 0.3765333333 -0.3765333333 -0.1041666667) (radius r) (material diel))

	(make sphere (center 0.3765333333 0.3780666667 0.2291666667) (radius r) (material diel))

	(make sphere (center -0.3780666667 -0.3765333333 -0.4375) (radius r) (material diel))

	(make sphere (center -0.3365666667 0.3365666667 -0.1041666667) (radius r) (material diel))

	(make sphere (center -0.3365666667 -0.0481333333 0.2291666667) (radius r) (material diel))

	(make sphere (center 0.0481333333 0.3365666667 -0.4375) (radius r) (material diel))

	(make sphere (center -0.0329666667 0.0329666667 -0.1041666667) (radius r) (material diel))

	(make sphere (center -0.0329666667 -0.4409333333 0.2291666667) (radius r) (material diel))

	(make sphere (center 0.4409333333 0.0329666667 -0.4375) (radius r) (material diel))

	(make sphere (center 0.0783333333 -0.2183333333 -0.2708333333) (radius r) (material diel))

	(make sphere (center 0.2183333333 -0.0783333333 0.0625) (radius r) (material diel))

	(make sphere (center 0.0783333333 -0.0783333333 0.3958333333) (radius r) (material diel))

	(make sphere (center -0.2749666667 -0.0460333333 -0.0228) (radius r) (material diel))

	(make sphere (center 0.0460333333 0.3960666667 0.3105333333) (radius r) (material diel))

	(make sphere (center -0.3960666667 0.2749666667 -0.3561333333) (radius r) (material diel))

	(make sphere (center -0.2749666667 0.3960666667 0.1478) (radius r) (material diel))

	(make sphere (center 0.0460333333 0.2749666667 -0.1855333333) (radius r) (material diel))

	(make sphere (center -0.3960666667 -0.0460333333 0.4811333333) (radius r) (material diel))

	(make sphere (center -0.0807666667 -0.1833333333 -0.2128) (radius r) (material diel))

	(make sphere (center 0.1833333333 -0.2724333333 0.1205333333) (radius r) (material diel))

	(make sphere (center 0.2724333333 0.0807666667 0.4538666667) (radius r) (material diel))

	(make sphere (center -0.0807666667 -0.2724333333 0.3378) (radius r) (material diel))

	(make sphere (center 0.1833333333 0.0807666667 0.0044666667) (radius r) (material diel))

	(make sphere (center 0.2724333333 -0.1833333333 -0.3288666667) (radius r) (material diel))
))
