...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.09733796) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254037815696 0.0) (basis3 0.0 0.0 1.097337957982141)))
...
(set! geometry (list (make sphere (center 0.472 0.0 0.6666666666666666) (radius r) (material diel))

	(make sphere (center 0.0 0.472 0.3333333333333333) (radius r) (material diel))

	(make sphere (center 0.528 0.528 0.0) (radius r) (material diel))

	(make sphere (center 0.408 0.265 0.786) (radius r) (material diel))

	(make sphere (center 0.735 0.143 0.45266666666666666) (radius r) (material diel))

	(make sphere (center 0.857 0.592 0.11933333333333333) (radius r) (material diel))

	(make sphere (center 0.265 0.408 0.214) (radius r) (material diel))

	(make sphere (center 0.143 0.735 0.5473333333333333) (radius r) (material diel))

	(make sphere (center 0.592 0.857 0.8806666666666667) (radius r) (material diel))
))
