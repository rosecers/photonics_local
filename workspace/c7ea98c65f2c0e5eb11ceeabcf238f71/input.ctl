(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.39296107) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.3929610723)))
...
(set! geometry (list (make sphere (center 0.3937555556 0.2319555556 0.0) (radius r) (material diel))

	(make sphere (center -0.1208444444 -0.2826444444 0.3333333333) (radius r) (material diel))

	(make sphere (center 0.3937555556 -0.2826444444 -0.3333333333) (radius r) (material diel))

	(make sphere (center -0.2826444444 -0.1208444444 0.0) (radius r) (material diel))

	(make sphere (center 0.2319555556 0.3937555556 0.3333333333) (radius r) (material diel))

	(make sphere (center -0.2826444444 0.3937555556 -0.3333333333) (radius r) (material diel))

	(make sphere (center 0.0555555556 -0.4444444444 0.0) (radius r) (material diel))

	(make sphere (center -0.4444444444 0.0555555556 0.3333333333) (radius r) (material diel))

	(make sphere (center 0.0555555556 0.0555555556 -0.3333333333) (radius r) (material diel))
))
