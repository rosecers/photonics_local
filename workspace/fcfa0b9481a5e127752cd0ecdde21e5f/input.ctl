...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.08233709) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0823370918)))
...
(set! geometry (list (make sphere (center -0.3076923077 -0.3076923077 -0.1776923077) (radius r) (material diel))

	(make sphere (center 0.1923076923 -0.3076923077 0.0803076923) (radius r) (material diel))

	(make sphere (center -0.3076923077 0.1923076923 0.0803076923) (radius r) (material diel))

	(make sphere (center 0.1923076923 0.1923076923 0.0803076923) (radius r) (material diel))

	(make sphere (center -0.3076923077 -0.3076923077 0.2943076923) (radius r) (material diel))

	(make sphere (center 0.0256410256 0.358974359 -0.4196923077) (radius r) (material diel))

	(make sphere (center 0.358974359 0.0256410256 -0.4196923077) (radius r) (material diel))

	(make sphere (center 0.0893076923 -0.3076923077 0.3873076923) (radius r) (material diel))

	(make sphere (center -0.3076923077 0.0893076923 0.3873076923) (radius r) (material diel))

	(make sphere (center 0.2953076923 0.2953076923 0.3873076923) (radius r) (material diel))

	(make sphere (center 0.2953076923 -0.3076923077 -0.2266923077) (radius r) (material diel))

	(make sphere (center -0.3076923077 0.2953076923 -0.2266923077) (radius r) (material diel))

	(make sphere (center 0.0893076923 0.0893076923 -0.2266923077) (radius r) (material diel))
))
