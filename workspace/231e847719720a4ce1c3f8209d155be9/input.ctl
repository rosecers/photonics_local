...
(set! geometry (list (make sphere (center 0.0990909091 -0.1609090909 0.0990909091) (radius r) (material diel))

	(make sphere (center 0.0990909091 0.0990909091 0.0990909091) (radius r) (material diel))

	(make sphere (center -0.1609090909 0.0990909091 0.0990909091) (radius r) (material diel))

	(make sphere (center 0.0990909091 0.0990909091 -0.1609090909) (radius r) (material diel))

	(make sphere (center -0.4009090909 0.3390909091 -0.4009090909) (radius r) (material diel))

	(make sphere (center -0.4009090909 -0.4009090909 -0.4009090909) (radius r) (material diel))

	(make sphere (center -0.4009090909 -0.4009090909 0.3390909091) (radius r) (material diel))

	(make sphere (center 0.3390909091 -0.4009090909 -0.4009090909) (radius r) (material diel))

	(make sphere (center -0.1459090909 0.4820909091 0.0500909091) (radius r) (material diel))

	(make sphere (center 0.0500909091 -0.2499090909 -0.1459090909) (radius r) (material diel))

	(make sphere (center 0.4820909091 -0.1459090909 -0.2499090909) (radius r) (material diel))

	(make sphere (center -0.2499090909 0.0500909091 0.4820909091) (radius r) (material diel))

	(make sphere (center 0.0500909091 0.4820909091 -0.2499090909) (radius r) (material diel))

	(make sphere (center -0.1459090909 -0.2499090909 0.4820909091) (radius r) (material diel))

	(make sphere (center -0.2499090909 -0.1459090909 0.0500909091) (radius r) (material diel))

	(make sphere (center 0.4820909091 0.0500909091 -0.1459090909) (radius r) (material diel))

	(make sphere (center -0.2499090909 0.4820909091 -0.1459090909) (radius r) (material diel))

	(make sphere (center 0.4820909091 -0.2499090909 0.0500909091) (radius r) (material diel))

	(make sphere (center 0.0500909091 -0.1459090909 0.4820909091) (radius r) (material diel))

	(make sphere (center -0.1459090909 0.0500909091 -0.2499090909) (radius r) (material diel))

	(make sphere (center -0.4499090909 -0.0179090909 0.3540909091) (radius r) (material diel))

	(make sphere (center 0.3540909091 0.2500909091 -0.4499090909) (radius r) (material diel))

	(make sphere (center 0.2500909091 0.3540909091 -0.0179090909) (radius r) (material diel))

	(make sphere (center -0.0179090909 -0.4499090909 0.2500909091) (radius r) (material diel))

	(make sphere (center 0.2500909091 -0.0179090909 -0.4499090909) (radius r) (material diel))

	(make sphere (center -0.0179090909 0.2500909091 0.3540909091) (radius r) (material diel))

	(make sphere (center -0.4499090909 0.3540909091 0.2500909091) (radius r) (material diel))

	(make sphere (center 0.3540909091 -0.4499090909 -0.0179090909) (radius r) (material diel))

	(make sphere (center 0.3540909091 -0.0179090909 0.2500909091) (radius r) (material diel))

	(make sphere (center -0.4499090909 0.2500909091 -0.0179090909) (radius r) (material diel))

	(make sphere (center -0.0179090909 0.3540909091 -0.4499090909) (radius r) (material diel))

	(make sphere (center 0.2500909091 -0.4499090909 0.3540909091) (radius r) (material diel))

	(make sphere (center 0.0340909091 0.0340909091 0.0340909091) (radius r) (material diel))

	(make sphere (center -0.4659090909 -0.4659090909 -0.4659090909) (radius r) (material diel))

	(make sphere (center -0.2159090909 -0.2159090909 -0.2159090909) (radius r) (material diel))

	(make sphere (center 0.2840909091 0.2840909091 0.2840909091) (radius r) (material diel))

	(make sphere (center -0.1379090909 -0.4499090909 -0.1379090909) (radius r) (material diel))

	(make sphere (center -0.1379090909 -0.1379090909 -0.1379090909) (radius r) (material diel))

	(make sphere (center -0.4499090909 -0.1379090909 -0.1379090909) (radius r) (material diel))

	(make sphere (center -0.1379090909 -0.1379090909 -0.4499090909) (radius r) (material diel))

	(make sphere (center 0.3620909091 0.0500909091 0.3620909091) (radius r) (material diel))

	(make sphere (center 0.3620909091 0.3620909091 0.3620909091) (radius r) (material diel))

	(make sphere (center 0.3620909091 0.3620909091 0.0500909091) (radius r) (material diel))

	(make sphere (center 0.0500909091 0.3620909091 0.3620909091) (radius r) (material diel))
))
