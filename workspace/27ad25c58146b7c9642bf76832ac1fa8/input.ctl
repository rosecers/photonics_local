(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.3880422) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.3880422039)))
...
(set! geometry (list (make sphere (center 0.0336666667 -0.3603333333 -0.4412666667) (radius r) (material diel))

	(make sphere (center 0.0496666667 0.4436666667 0.0587333333) (radius r) (material diel))

	(make sphere (center 0.4436666667 0.0496666667 0.3162666667) (radius r) (material diel))

	(make sphere (center -0.3603333333 0.0336666667 -0.1837333333) (radius r) (material diel))

	(make sphere (center -0.0643333333 0.4436666667 0.4829333333) (radius r) (material diel))

	(make sphere (center 0.1476666667 -0.3603333333 -0.0170666667) (radius r) (material diel))

	(make sphere (center 0.0336666667 -0.0643333333 -0.3504) (radius r) (material diel))

	(make sphere (center 0.0496666667 0.1476666667 0.1496) (radius r) (material diel))

	(make sphere (center 0.4436666667 -0.0643333333 -0.1079333333) (radius r) (material diel))

	(make sphere (center -0.3603333333 0.1476666667 0.3920666667) (radius r) (material diel))

	(make sphere (center -0.0643333333 0.0336666667 -0.2746) (radius r) (material diel))

	(make sphere (center 0.1476666667 0.0496666667 0.2254) (radius r) (material diel))

	(make sphere (center -0.2570333333 0.3403666667 0.4375) (radius r) (material diel))

	(make sphere (center 0.3403666667 -0.2570333333 -0.0625) (radius r) (material diel))

	(make sphere (center -0.0557333333 -0.2570333333 -0.3958333333) (radius r) (material diel))

	(make sphere (center 0.1390666667 0.3403666667 0.1041666667) (radius r) (material diel))

	(make sphere (center -0.2570333333 -0.0557333333 -0.2291666667) (radius r) (material diel))

	(make sphere (center 0.3403666667 0.1390666667 0.2708333333) (radius r) (material diel))

	(make sphere (center 0.0426666667 0.0426666667 0.1875) (radius r) (material diel))

	(make sphere (center 0.0406666667 0.0406666667 -0.3125) (radius r) (material diel))

	(make sphere (center -0.4583333333 0.0406666667 -0.1458333333) (radius r) (material diel))

	(make sphere (center -0.4583333333 0.0426666667 0.3541666667) (radius r) (material diel))

	(make sphere (center 0.0426666667 -0.4583333333 0.0208333333) (radius r) (material diel))

	(make sphere (center 0.0406666667 -0.4583333333 -0.4791666667) (radius r) (material diel))
))
