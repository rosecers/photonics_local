...
(set! geometry (list (make sphere (center 0.0974444444 0.1944444444 -0.1525555556) (radius r) (material diel))
	...
	(make sphere (center 0.0254444444 0.0974444444 0.3724444444) (radius r) (material diel))

	(make sphere (center -0.1275555556 -0.2805555556 0.2914444444) (radius r) (material diel))

	(make sphere (center 0.0974444444 0.0164444444 -0.3305555556) (radius r) (material diel))

	(make sphere (center -0.2805555556 0.2914444444 -0.1275555556) (radius r) (material diel))

	(make sphere (center 0.0164444444 -0.3305555556 0.0974444444) (radius r) (material diel))

	(make sphere (center 0.0974444444 0.3724444444 0.0254444444) (radius r) (material diel))
