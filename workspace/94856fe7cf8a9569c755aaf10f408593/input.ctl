(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.71868289) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.7186828945)))
...
(set! geometry (list (make sphere (center 0.499 0.168 0.44862) (radius r) (material diel))

	(make sphere (center -0.169 0.499 -0.3847133333) (radius r) (material diel))

	(make sphere (center -0.168 -0.169 -0.2180466667) (radius r) (material diel))

	(make sphere (center -0.499 -0.168 -0.05138) (radius r) (material diel))

	(make sphere (center 0.169 -0.499 0.1152866667) (radius r) (material diel))

	(make sphere (center 0.168 0.169 0.2819533333) (radius r) (material diel))

	(make sphere (center 0.1875 -0.4995 -0.52848) (radius r) (material diel))

	(make sphere (center 0.187 0.1875 -0.3618133333) (radius r) (material diel))

	(make sphere (center 0.4995 0.187 -0.1951466667) (radius r) (material diel))

	(make sphere (center -0.1875 0.4995 -0.02848) (radius r) (material diel))

	(make sphere (center -0.187 -0.1875 0.1381866667) (radius r) (material diel))

	(make sphere (center -0.4995 -0.187 0.3048533333) (radius r) (material diel))

	(make sphere (center 0.222 -0.461 -0.39768) (radius r) (material diel))

	(make sphere (center 0.183 0.222 -0.2310133333) (radius r) (material diel))

	(make sphere (center 0.461 0.183 -0.0643466667) (radius r) (material diel))

	(make sphere (center -0.222 0.461 0.10232) (radius r) (material diel))

	(make sphere (center -0.183 -0.222 0.2689866667) (radius r) (material diel))

	(make sphere (center -0.461 -0.183 0.4356533333) (radius r) (material diel))

	(make sphere (center -0.197 -0.146 -0.37068) (radius r) (material diel))

	(make sphere (center 0.449 -0.197 -0.2040133333) (radius r) (material diel))

	(make sphere (center 0.146 0.449 -0.0373466667) (radius r) (material diel))

	(make sphere (center 0.197 0.146 0.12932) (radius r) (material diel))

	(make sphere (center -0.449 0.197 0.2959866667) (radius r) (material diel))

	(make sphere (center -0.146 -0.449 0.4626533333) (radius r) (material diel))

	(make sphere (center 0.475 0.123 -0.40178) (radius r) (material diel))

	(make sphere (center -0.148 0.475 -0.2351133333) (radius r) (material diel))

	(make sphere (center -0.123 -0.148 -0.0684466667) (radius r) (material diel))

	(make sphere (center -0.475 -0.123 0.09822) (radius r) (material diel))

	(make sphere (center 0.148 -0.475 0.2648866667) (radius r) (material diel))

	(make sphere (center 0.123 0.148 0.4315533333) (radius r) (material diel))
))
