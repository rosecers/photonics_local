...
(set! geometry (list (make sphere (center 0.0 0.0 0.0688) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.9312) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.5688) (radius r) (material diel))

	(make sphere (center 0.0 0.0 0.4312) (radius r) (material diel))
