...
(set! geometry (list (make sphere (center -0.3611111111 0.1388888889 -0.3611111111) (radius r) (material diel))

	(make sphere (center -0.3611111111 -0.3611111111 -0.3611111111) (radius r) (material diel))

	(make sphere (center 0.1388888889 -0.3611111111 -0.3611111111) (radius r) (material diel))

	(make sphere (center -0.3611111111 -0.3611111111 0.1388888889) (radius r) (material diel))

	(make sphere (center 0.2208888889 -0.1931111111 -0.1931111111) (radius r) (material diel))

	(make sphere (center 0.0568888889 0.4708888889 0.4708888889) (radius r) (material diel))

	(make sphere (center -0.1931111111 0.2208888889 0.2208888889) (radius r) (material diel))

	(make sphere (center 0.4708888889 0.0568888889 0.0568888889) (radius r) (material diel))

	(make sphere (center -0.1931111111 -0.1931111111 0.2208888889) (radius r) (material diel))

	(make sphere (center 0.4708888889 0.4708888889 0.0568888889) (radius r) (material diel))

	(make sphere (center 0.2208888889 0.2208888889 -0.1931111111) (radius r) (material diel))

	(make sphere (center 0.0568888889 0.0568888889 0.4708888889) (radius r) (material diel))

	(make sphere (center 0.2208888889 -0.1931111111 0.2208888889) (radius r) (material diel))

	(make sphere (center 0.0568888889 0.4708888889 0.0568888889) (radius r) (material diel))

	(make sphere (center -0.1931111111 0.2208888889 -0.1931111111) (radius r) (material diel))

	(make sphere (center 0.4708888889 0.0568888889 0.4708888889) (radius r) (material diel))

	(make sphere (center -0.4861111111 -0.4861111111 -0.4861111111) (radius r) (material diel))

	(make sphere (center -0.2361111111 -0.2361111111 -0.2361111111) (radius r) (material diel))
))
