(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.43622794) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.4362279355)))
...
(set! geometry (list (make sphere (center 0.05555555555555555 0.05555555555555555 0.333333) (radius r) (material diel))

	(make sphere (center 0.05555555555555555 -0.4444444444444444 0.0) (radius r) (material diel))

	(make sphere (center -0.4444444444444444 0.05555555555555555 -0.333333) (radius r) (material diel))

	(make sphere (center -0.2777777777777778 0.3888888888888889 0.333333) (radius r) (material diel))

	(make sphere (center -0.2777777777777778 -0.1111111111111111 0.0) (radius r) (material diel))

	(make sphere (center 0.2222222222222222 0.3888888888888889 -0.333333) (radius r) (material diel))

	(make sphere (center 0.3888888888888889 -0.2777777777777778 0.333333) (radius r) (material diel))

	(make sphere (center 0.3888888888888889 0.2222222222222222 0.0) (radius r) (material diel))

	(make sphere (center -0.1111111111111111 -0.2777777777777778 -0.333333) (radius r) (material diel))
))
