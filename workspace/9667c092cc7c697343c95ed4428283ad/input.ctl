...
(set! geometry (list (make sphere (center -0.4 -0.4 -0.4) (radius r) (material diel))
	...
	(make sphere (center -0.4 0.1 0.1) (radius r) (material diel))

	(make sphere (center 0.1 0.1 -0.4) (radius r) (material diel))

	(make sphere (center 0.1 -0.4 0.1) (radius r) (material diel))

	(make sphere (center 0.097 -0.195 -0.108) (radius r) (material diel))

	(make sphere (center 0.103 0.395 0.308) (radius r) (material diel))

	(make sphere (center -0.313 0.395 -0.108) (radius r) (material diel))

	(make sphere (center 0.513 -0.195 0.308) (radius r) (material diel))

	(make sphere (center -0.195 0.308 0.513) (radius r) (material diel))

	(make sphere (center 0.395 -0.108 -0.313) (radius r) (material diel))

	(make sphere (center 0.395 0.308 0.103) (radius r) (material diel))

	(make sphere (center -0.195 -0.108 0.097) (radius r) (material diel))

	(make sphere (center -0.108 -0.313 0.395) (radius r) (material diel))

	(make sphere (center 0.308 0.513 -0.195) (radius r) (material diel))

	(make sphere (center -0.108 0.097 -0.195) (radius r) (material diel))

	(make sphere (center 0.308 0.103 0.395) (radius r) (material diel))

	(make sphere (center 0.1 -0.4 -0.4) (radius r) (material diel))
