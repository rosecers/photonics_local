...
(set! geometry (list (make sphere (center -0.462962963 -0.462962963 0.1312592593) (radius r) (material diel))
	...
	(make sphere (center 0.18537037037 -0.462962963 0.0092592593) (radius r) (material diel))
	(make sphere (center 0.18537037037 0.037037037 0.0092592593) (radius r) (material diel))
	...
	(make sphere (center 0.18574037037 0.074037037 -0.3417407407) (radius r) (material diel))
	...
	(make sphere (center 0.18574037037 0.463037037 -0.3417407407) (radius r) (material diel))
	...
	(make sphere (center 0.18566037037 0.066037037 -0.0917407407) (radius r) (material diel))
	...
	(make sphere (center 0.18566037037 0.480037037 -0.0917407407) (radius r) (material diel))
	(make sphere (center 0.18508037037 0.008037037 0.1102592593) (radius r) (material diel))
	...
	(make sphere (center 0.18508037037 -0.405962963 0.1102592593) (radius r) (material diel))
