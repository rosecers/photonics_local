(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.5660522) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.5660521987)))
...
(set! geometry (list (make sphere (center -0.07333333333333333 -0.3333333333333333 -0.23333333333333334) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 -0.07333333333333333 -0.23333333333333334) (radius r) (material diel))

	(make sphere (center 0.4066666666666667 0.4066666666666667 -0.23333333333333334) (radius r) (material diel))

	(make sphere (center 0.26166666666666666 -0.3333333333333333 0.26666666666666666) (radius r) (material diel))

	(make sphere (center -0.3333333333333333 0.26166666666666666 0.26666666666666666) (radius r) (material diel))

	(make sphere (center 0.07166666666666667 0.07166666666666667 0.26666666666666666) (radius r) (material diel))

	(make sphere (center -0.07333333333333333 -0.3333333333333333 -0.23333333333333334) (radius r) (material diel))
	...
	(make sphere (center -0.3333333333333333 -0.3333333333333333 0.26666666666666666) (radius r) (material diel))

	(make sphere (center 0.0 0.3333333333333333 -0.23333333333333334) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.0 -0.23333333333333334) (radius r) (material diel))
))
