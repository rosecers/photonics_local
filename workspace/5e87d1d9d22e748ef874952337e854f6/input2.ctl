...
(set! geometry (list (make sphere (center -0.4117647059 -0.4117647059 -0.4117647059) (radius r) (material diel))

	(make sphere (center 0.0882352941 -0.4117647059 -0.4117647059) (radius r) (material diel))

	(make sphere (center 0.0882352941 0.0882352941 0.0882352941) (radius r) (material diel))

	(make sphere (center -0.4117647059 -0.4117647059 0.0882352941) (radius r) (material diel))

	(make sphere (center -0.4117647059 0.0882352941 -0.4117647059) (radius r) (material diel))

	(make sphere (center -0.0527647059 0.4452352941 -0.1957647059) (radius r) (material diel))

	(make sphere (center 0.2292352941 -0.2687647059 0.3722352941) (radius r) (material diel))

	(make sphere (center 0.2292352941 0.4452352941 0.0862352941) (radius r) (material diel))

	(make sphere (center -0.0527647059 -0.2687647059 0.0902352941) (radius r) (material diel))

	(make sphere (center -0.2687647059 0.3722352941 0.2292352941) (radius r) (material diel))

	(make sphere (center 0.4452352941 -0.1957647059 -0.0527647059) (radius r) (material diel))

	(make sphere (center -0.2687647059 0.0902352941 -0.0527647059) (radius r) (material diel))

	(make sphere (center 0.4452352941 0.0862352941 0.2292352941) (radius r) (material diel))

	(make sphere (center 0.0902352941 -0.0527647059 -0.2687647059) (radius r) (material diel))

	(make sphere (center 0.0862352941 0.2292352941 0.4452352941) (radius r) (material diel))

	(make sphere (center 0.3722352941 0.2292352941 -0.2687647059) (radius r) (material diel))

	(make sphere (center -0.1957647059 -0.0527647059 0.4452352941) (radius r) (material diel))
))
