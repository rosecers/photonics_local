...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.52330775) (basis1 1.0 0.0 0.0) (basis2 0.0 1.0 0.0) (basis3 0.0 0.0 0.523307753)))
...
(set! geometry (list (make sphere (center 0.0624 0.2566 0.0) (radius r) (material diel))
