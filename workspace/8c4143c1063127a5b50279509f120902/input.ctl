...
(set! geometry (list (make sphere (center 0.0357857143 0.2857857143 0.4107857143) (radius r) (material diel))

	(make sphere (center 0.0357857143 -0.2142142857 0.1607857143) (radius r) (material diel))

	(make sphere (center -0.4642142857 0.2857857143 -0.3392142857) (radius r) (material diel))

	(make sphere (center -0.4642142857 -0.2142142857 -0.0892142857) (radius r) (material diel))

	(make sphere (center 0.4107857143 0.0357857143 0.2857857143) (radius r) (material diel))

	(make sphere (center 0.1607857143 0.0357857143 -0.2142142857) (radius r) (material diel))

	(make sphere (center -0.3392142857 -0.4642142857 0.2857857143) (radius r) (material diel))

	(make sphere (center -0.0892142857 -0.4642142857 -0.2142142857) (radius r) (material diel))

	(make sphere (center 0.2857857143 0.4107857143 0.0357857143) (radius r) (material diel))

	(make sphere (center -0.2142142857 0.1607857143 0.0357857143) (radius r) (material diel))

	(make sphere (center 0.2857857143 -0.3392142857 -0.4642142857) (radius r) (material diel))

	(make sphere (center -0.2142142857 -0.0892142857 -0.4642142857) (radius r) (material diel))

	(make sphere (center 0.1087857143 0.1087857143 0.1087857143) (radius r) (material diel))

	(make sphere (center -0.0372142857 -0.3912142857 0.4617857143) (radius r) (material diel))

	(make sphere (center -0.3912142857 0.4617857143 -0.0372142857) (radius r) (material diel))

	(make sphere (center 0.4617857143 -0.0372142857 -0.3912142857) (radius r) (material diel))

	(make sphere (center 0.3597857143 0.3597857143 0.3597857143) (radius r) (material diel))

	(make sphere (center -0.2872142857 -0.1412142857 0.2117857143) (radius r) (material diel))

	(make sphere (center 0.2117857143 -0.2872142857 -0.1412142857) (radius r) (material diel))

	(make sphere (center -0.1412142857 0.2117857143 -0.2872142857) (radius r) (material diel))

	(make sphere (center -0.3912142857 -0.3912142857 -0.3912142857) (radius r) (material diel))

	(make sphere (center 0.4617857143 0.1087857143 -0.0372142857) (radius r) (material diel))

	(make sphere (center 0.1087857143 -0.0372142857 0.4617857143) (radius r) (material diel))

	(make sphere (center -0.0372142857 0.4617857143 0.1087857143) (radius r) (material diel))

	(make sphere (center -0.1412142857 -0.1412142857 -0.1412142857) (radius r) (material diel))

	(make sphere (center 0.2117857143 0.3597857143 -0.2872142857) (radius r) (material diel))

	(make sphere (center -0.2872142857 0.2117857143 0.3597857143) (radius r) (material diel))

	(make sphere (center 0.3597857143 -0.2872142857 0.2117857143) (radius r) (material diel))
))
