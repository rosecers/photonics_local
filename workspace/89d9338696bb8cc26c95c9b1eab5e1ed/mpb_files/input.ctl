...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.08233707) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0823370657)))
...
(set! geometry (list (make sphere (center -0.30769230997144725 -0.30769230998654346 -0.17769231241535838) (radius r) (material diel))

	(make sphere (center 0.19230769005380954 -0.30769230998654346 0.08030770374652718) (radius r) (material diel))

	(make sphere (center -0.30769230987493185 0.19230769007178455 0.08030770374652718) (radius r) (material diel))

	(make sphere (center 0.19230768998194642 0.19230769007178455 0.08030770374652718) (radius r) (material diel))

	(make sphere (center -0.30769230997144725 -0.30769230998654346 0.2943076904786056) (radius r) (material diel))

	(make sphere (center 0.08930770476320471 -0.30769230998654346 0.3873076851088326) (radius r) (material diel))

	(make sphere (center -0.30769231005790004 0.089307704750266 0.3873076851088326) (radius r) (material diel))

	(make sphere (center 0.2953076751899276 0.2953076751988765 0.3873076851088326) (radius r) (material diel))

	(make sphere (center 0.29530767517603584 -0.30769230998654346 -0.22669230748510008) (radius r) (material diel))

	(make sphere (center -0.3076923099575554 0.2953076751988765 -0.22669230748510008) (radius r) (material diel))

	(make sphere (center 0.08930770484513045 0.089307704750266 -0.22669230748510008) (radius r) (material diel))

	(make sphere (center 0.025641033310923544 0.35897437658942327 -0.4196923110870136) (radius r) (material diel))

	(make sphere (center 0.3589743765123039 0.02564103330143991 -0.4196923110870136) (radius r) (material diel))
))
