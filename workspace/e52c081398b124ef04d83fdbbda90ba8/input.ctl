...
(set! geometry (list (make sphere (center 0.2272727273 -0.2727272727 0.2272727273) (radius r) (material diel))

	(make sphere (center 0.2272727273 0.2272727273 0.2272727273) (radius r) (material diel))

	(make sphere (center -0.2727272727 0.2272727273 0.2272727273) (radius r) (material diel))

	(make sphere (center 0.2272727273 0.2272727273 -0.2727272727) (radius r) (material diel))

	(make sphere (center -0.2727272727 0.2272727273 -0.2727272727) (radius r) (material diel))

	(make sphere (center -0.2727272727 -0.2727272727 -0.2727272727) (radius r) (material diel))

	(make sphere (center 0.2272727273 -0.2727272727 -0.2727272727) (radius r) (material diel))

	(make sphere (center -0.2727272727 -0.2727272727 0.2272727273) (radius r) (material diel))

	(make sphere (center 0.3522727273 0.3522727273 0.3522727273) (radius r) (material diel))

	(make sphere (center 0.1022727273 0.1022727273 0.1022727273) (radius r) (material diel))

	(make sphere (center -0.3347272727 0.0392727273 0.0392727273) (radius r) (material diel))

	(make sphere (center 0.0392727273 -0.3347272727 -0.3347272727) (radius r) (material diel))

	(make sphere (center 0.0392727273 0.0392727273 -0.3347272727) (radius r) (material diel))

	(make sphere (center -0.3347272727 -0.3347272727 0.0392727273) (radius r) (material diel))

	(make sphere (center -0.3347272727 0.0392727273 -0.3347272727) (radius r) (material diel))

	(make sphere (center 0.0392727273 -0.3347272727 0.0392727273) (radius r) (material diel))

	(make sphere (center -0.2107272727 -0.2107272727 0.4152727273) (radius r) (material diel))

	(make sphere (center 0.4152727273 0.4152727273 -0.2107272727) (radius r) (material diel))

	(make sphere (center 0.4152727273 -0.2107272727 -0.2107272727) (radius r) (material diel))

	(make sphere (center -0.2107272727 0.4152727273 0.4152727273) (radius r) (material diel))

	(make sphere (center -0.2107272727 0.4152727273 -0.2107272727) (radius r) (material diel))

	(make sphere (center 0.4152727273 -0.2107272727 0.4152727273) (radius r) (material diel))
))
