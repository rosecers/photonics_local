...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.09464026) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0946402556)))
...
(set! geometry (list (make sphere (center 0.4166666666666667 0.2671 0.21312) (radius r) (material diel))

	(make sphere (center 0.7329 0.14956666666666665 0.5464533333333333) (radius r) (material diel))

	(make sphere (center 0.8504333333333334 0.5833333333333334 0.8797866666666667) (radius r) (material diel))

	(make sphere (center 0.2671 0.4166666666666667 0.78688) (radius r) (material diel))

	(make sphere (center 0.14956666666666665 0.7329 0.45354666666666665) (radius r) (material diel))

	(make sphere (center 0.5833333333333334 0.8504333333333334 0.12021333333333334) (radius r) (material diel))

	(make sphere (center 0.47 0.0 0.3333333333333333) (radius r) (material diel))

	(make sphere (center 0.0 0.47 0.6666666666666666) (radius r) (material diel))

	(make sphere (center 0.53 0.53 0.0) (radius r) (material diel))
))
