...
(set! geometry (list (make sphere (center -0.0990531034 -0.4137931034 -0.4137931034) (radius r) (material diel))

	(make sphere (center -0.4137931034 -0.4137931034 -0.0990531034) (radius r) (material diel))

	(make sphere (center 0.2714668966 0.2714668966 0.2714668966) (radius r) (material diel))

	(make sphere (center -0.4137931034 -0.0990531034 -0.4137931034) (radius r) (material diel))

	(make sphere (center -0.0522631034 0.0862068966 0.4477368966) (radius r) (material diel))

	(make sphere (center 0.4477368966 -0.0522631034 0.0862068966) (radius r) (material diel))

	(make sphere (center 0.0862068966 -0.2753231034 0.2246768966) (radius r) (material diel))

	(make sphere (center -0.2753231034 0.2246768966 0.0862068966) (radius r) (material diel))

	(make sphere (center 0.0862068966 0.4477368966 -0.0522631034) (radius r) (material diel))

	(make sphere (center 0.2246768966 0.0862068966 -0.2753231034) (radius r) (material diel))

	(make sphere (center -0.0909931034 -0.4137931034 -0.0909931034) (radius r) (material diel))

	(make sphere (center -0.0909931034 -0.0909931034 -0.4137931034) (radius r) (material diel))

	(make sphere (center -0.4137931034 0.2634068966 0.2634068966) (radius r) (material diel))

	(make sphere (center 0.2634068966 0.2634068966 -0.4137931034) (radius r) (material diel))

	(make sphere (center -0.4137931034 -0.0909931034 -0.0909931034) (radius r) (material diel))

	(make sphere (center 0.2634068966 -0.4137931034 0.2634068966) (radius r) (material diel))

	(make sphere (center -0.4137931034 -0.4137931034 -0.4137931034) (radius r) (material diel))

	(make sphere (center -0.0944631034 0.2809468966 -0.3567831034) (radius r) (material diel))

	(make sphere (center 0.2107968966 -0.0515231034 -0.1085331034) (radius r) (material diel))

	(make sphere (center -0.1514731034 0.5291968966 0.2239368966) (radius r) (material diel))

	(make sphere (center -0.0515231034 -0.1085331034 0.2107968966) (radius r) (material diel))

	(make sphere (center 0.5291968966 0.2239368966 -0.1514731034) (radius r) (material diel))

	(make sphere (center 0.2809468966 -0.3567831034 -0.0944631034) (radius r) (material diel))

	(make sphere (center 0.2668768966 0.3238868966 -0.0383831034) (radius r) (material diel))

	(make sphere (center -0.0383831034 0.2668768966 0.3238868966) (radius r) (material diel))

	(make sphere (center 0.3238868966 -0.0383831034 0.2668768966) (radius r) (material diel))

	(make sphere (center 0.2239368966 -0.1514731034 0.5291968966) (radius r) (material diel))

	(make sphere (center -0.3567831034 -0.0944631034 0.2809468966) (radius r) (material diel))

	(make sphere (center -0.1085331034 0.2107968966 -0.0515231034) (radius r) (material diel))
))
