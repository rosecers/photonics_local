(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.68394873) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.6839487328)))
...
(set! geometry (list (make sphere (center -0.3571428571 -0.3571428571 -0.1428571429) (radius r) (material diel))

	(make sphere (center -0.3571428571 -0.3571428571 0.3571428571) (radius r) (material diel))

	(make sphere (center -0.0238095238 0.3095238095 -0.3418571429) (radius r) (material diel))

	(make sphere (center 0.3095238095 -0.0238095238 0.5561428571) (radius r) (material diel))

	(make sphere (center 0.3095238095 -0.0238095238 0.1581428571) (radius r) (material diel))

	(make sphere (center -0.0238095238 0.3095238095 0.0561428571) (radius r) (material diel))

	(make sphere (center -0.0238095238 0.3095238095 -0.1428571429) (radius r) (material diel))

	(make sphere (center 0.3095238095 -0.0238095238 0.3571428571) (radius r) (material diel))

	(make sphere (center -0.0141428571 -0.3571428571 -0.3928571429) (radius r) (material diel))

	(make sphere (center -0.3571428571 -0.0141428571 -0.3928571429) (radius r) (material diel))

	(make sphere (center 0.2998571429 0.2998571429 -0.3928571429) (radius r) (material diel))

	(make sphere (center 0.2998571429 -0.3571428571 0.1071428571) (radius r) (material diel))

	(make sphere (center -0.3571428571 0.2998571429 0.1071428571) (radius r) (material diel))

	(make sphere (center -0.0141428571 -0.0141428571 0.1071428571) (radius r) (material diel))
))
