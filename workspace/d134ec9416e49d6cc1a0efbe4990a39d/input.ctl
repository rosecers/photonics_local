...
(set! geometry (list (make sphere (center 0.0123636364 -0.3636363636 -0.3636363636) (radius r) (material diel))

	(make sphere (center 0.2603636364 0.2603636364 0.2603636364) (radius r) (material diel))

	(make sphere (center -0.3636363636 -0.3636363636 0.0123636364) (radius r) (material diel))

	(make sphere (center -0.3636363636 0.0123636364 -0.3636363636) (radius r) (material diel))

	(make sphere (center 0.0543636364 0.4003636364 0.4003636364) (radius r) (material diel))

	(make sphere (center 0.2183636364 -0.0176363636 -0.0176363636) (radius r) (material diel))

	(make sphere (center -0.3636363636 -0.1276363636 0.2903636364) (radius r) (material diel))

	(make sphere (center -0.3636363636 0.2903636364 -0.1276363636) (radius r) (material diel))

	(make sphere (center 0.2903636364 -0.1276363636 -0.3636363636) (radius r) (material diel))

	(make sphere (center -0.1276363636 0.2903636364 -0.3636363636) (radius r) (material diel))

	(make sphere (center -0.0176363636 -0.0176363636 0.2183636364) (radius r) (material diel))

	(make sphere (center 0.4003636364 0.4003636364 0.0543636364) (radius r) (material diel))

	(make sphere (center 0.2903636364 -0.3636363636 -0.1276363636) (radius r) (material diel))

	(make sphere (center -0.1276363636 -0.3636363636 0.2903636364) (radius r) (material diel))

	(make sphere (center 0.4003636364 0.0543636364 0.4003636364) (radius r) (material diel))

	(make sphere (center -0.0176363636 0.2183636364 -0.0176363636) (radius r) (material diel))

	(make sphere (center -0.3636363636 0.4143636364 0.4143636364) (radius r) (material diel))

	(make sphere (center -0.3636363636 -0.1416363636 -0.1416363636) (radius r) (material diel))

	(make sphere (center -0.1416363636 -0.1416363636 -0.3636363636) (radius r) (material diel))

	(make sphere (center 0.4143636364 0.4143636364 -0.3636363636) (radius r) (material diel))

	(make sphere (center -0.1416363636 -0.3636363636 -0.1416363636) (radius r) (material diel))

	(make sphere (center 0.4143636364 -0.3636363636 0.4143636364) (radius r) (material diel))
))
