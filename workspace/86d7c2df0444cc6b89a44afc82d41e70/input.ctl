...
(set! geometry (list (make sphere (center -0.2857142857 -0.2857142857 -0.2857142857) (radius r) (material diel))

	(make sphere (center 0.0042857143 0.0042857143 -0.2857142857) (radius r) (material diel))

	(make sphere (center 0.4242857143 0.4242857143 -0.2857142857) (radius r) (material diel))

	(make sphere (center 0.0042857143 -0.2857142857 0.0042857143) (radius r) (material diel))

	(make sphere (center 0.4242857143 -0.2857142857 0.4242857143) (radius r) (material diel))

	(make sphere (center -0.2857142857 0.4242857143 0.4242857143) (radius r) (material diel))

	(make sphere (center -0.2857142857 0.0042857143 0.0042857143) (radius r) (material diel))
))
