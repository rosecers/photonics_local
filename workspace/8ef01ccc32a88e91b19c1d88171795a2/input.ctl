...
(set! geometry (list (make sphere (center 0.0625 -0.4375 -0.4375) (radius r) (material diel))

	(make sphere (center 0.0625 0.0625 0.0625) (radius r) (material diel))

	(make sphere (center -0.4375 -0.4375 0.0625) (radius r) (material diel))

	(make sphere (center -0.4375 0.0625 -0.4375) (radius r) (material diel))

	(make sphere (center -0.0975 0.4125 -0.2475) (radius r) (material diel))

	(make sphere (center 0.2225 -0.2875 0.3725) (radius r) (material diel))

	(make sphere (center 0.2225 0.4125 0.0725) (radius r) (material diel))

	(make sphere (center -0.0975 -0.2875 0.0525) (radius r) (material diel))

	(make sphere (center -0.2875 0.3725 0.2225) (radius r) (material diel))

	(make sphere (center 0.4125 -0.2475 -0.0975) (radius r) (material diel))

	(make sphere (center -0.2875 0.0525 -0.0975) (radius r) (material diel))

	(make sphere (center 0.4125 0.0725 0.2225) (radius r) (material diel))

	(make sphere (center 0.0525 -0.0975 -0.2875) (radius r) (material diel))

	(make sphere (center 0.0725 0.2225 0.4125) (radius r) (material diel))

	(make sphere (center 0.3725 0.2225 -0.2875) (radius r) (material diel))

	(make sphere (center -0.2475 -0.0975 0.4125) (radius r) (material diel))
))
