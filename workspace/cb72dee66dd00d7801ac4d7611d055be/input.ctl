...
(set! geometry (list (make sphere (center -0.2775384615 0.2294615385 0.4134615385) (radius r) (material diel))

	(make sphere (center 0.3544615385 -0.1525384615 -0.3365384615) (radius r) (material diel))

	(make sphere (center 0.3544615385 0.2294615385 0.0454615385) (radius r) (material diel))

	(make sphere (center -0.2775384615 -0.1525384615 0.0314615385) (radius r) (material diel))

	(make sphere (center -0.1525384615 -0.3365384615 0.3544615385) (radius r) (material diel))

	(make sphere (center 0.2294615385 0.4134615385 -0.2775384615) (radius r) (material diel))

	(make sphere (center -0.1525384615 0.0314615385 -0.2775384615) (radius r) (material diel))

	(make sphere (center 0.2294615385 0.0454615385 0.3544615385) (radius r) (material diel))

	(make sphere (center 0.0314615385 -0.2775384615 -0.1525384615) (radius r) (material diel))

	(make sphere (center 0.0454615385 0.3544615385 0.2294615385) (radius r) (material diel))

	(make sphere (center -0.3365384615 0.3544615385 -0.1525384615) (radius r) (material diel))

	(make sphere (center 0.4134615385 -0.2775384615 0.2294615385) (radius r) (material diel))

	(make sphere (center -0.4615384615 -0.4615384615 -0.4615384615) (radius r) (material diel))
))
