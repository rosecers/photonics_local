...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.48642204) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.4864220396)))
...
(set! geometry (list (make sphere (center 0.3333333333333333 0.6666666666666666 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.346 0.0 0.28) (radius r) (material diel))

	(make sphere (center 0.654 0.0 0.72) (radius r) (material diel))

	(make sphere (center 0.0 0.346 0.28) (radius r) (material diel))

	(make sphere (center 0.0 0.654 0.72) (radius r) (material diel))

	(make sphere (center 0.654 0.654 0.28) (radius r) (material diel))

	(make sphere (center 0.346 0.346 0.72) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.225) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.775) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.775) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.225) (radius r) (material diel))
