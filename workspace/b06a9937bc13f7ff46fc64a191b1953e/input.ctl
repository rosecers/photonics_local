(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.19495258) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.1949525836)))
...
(set! geometry (list (make sphere (center 0.0555555556 0.0555555556 -0.3055555556) (radius r) (material diel))

	(make sphere (center 0.0555555556 -0.4444444444 0.0277777778) (radius r) (material diel))

	(make sphere (center -0.4444444444 0.0555555556 0.3611111111) (radius r) (material diel))

	(make sphere (center 0.0555555556 0.0555555556 0.1944444444) (radius r) (material diel))

	(make sphere (center 0.0555555556 -0.4444444444 -0.4722222222) (radius r) (material diel))

	(make sphere (center -0.4444444444 0.0555555556 -0.1388888889) (radius r) (material diel))

	(make sphere (center -0.0243444444 -0.2529444444 -0.0498555522) (radius r) (material diel))

	(make sphere (center 0.3640555556 -0.2158444444 0.2834777811) (radius r) (material diel))

	(make sphere (center 0.3269555556 0.1354555556 -0.3831888856) (radius r) (material diel))

	(make sphere (center 0.1354555556 0.3640555556 -0.0498555522) (radius r) (material diel))

	(make sphere (center -0.2529444444 0.3269555556 0.2834777811) (radius r) (material diel))

	(make sphere (center -0.2158444444 -0.0243444444 -0.3831888856) (radius r) (material diel))

	(make sphere (center -0.2529444444 -0.0243444444 0.4387444411) (radius r) (material diel))

	(make sphere (center -0.2158444444 0.3640555556 0.1054111078) (radius r) (material diel))

	(make sphere (center 0.1354555556 0.3269555556 -0.2279222256) (radius r) (material diel))

	(make sphere (center 0.3640555556 0.1354555556 0.4387444411) (radius r) (material diel))

	(make sphere (center 0.3269555556 -0.2529444444 0.1054111078) (radius r) (material diel))

	(make sphere (center -0.0243444444 -0.2158444444 -0.2279222256) (radius r) (material diel))
))
