...
(set! geometry (list (make sphere (center 0.0882352941 -0.4117647059 -0.4117647059) (radius r) (material diel))
	...
	(make sphere (center -0.2017647059 0.2942352941 0.5042352941) (radius r) (material diel))

	(make sphere (center 0.3782352941 -0.1177647059 -0.3277647059) (radius r) (material diel))

	(make sphere (center 0.3782352941 0.2942352941 0.0842352941) (radius r) (material diel))

	(make sphere (center -0.2017647059 -0.1177647059 0.0922352941) (radius r) (material diel))

	(make sphere (center -0.1177647059 -0.3277647059 0.3782352941) (radius r) (material diel))

	(make sphere (center 0.2942352941 0.5042352941 -0.2017647059) (radius r) (material diel))

	(make sphere (center -0.1177647059 0.0922352941 -0.2017647059) (radius r) (material diel))

	(make sphere (center 0.2942352941 0.0842352941 0.3782352941) (radius r) (material diel))

	(make sphere (center 0.0922352941 -0.2017647059 -0.1177647059) (radius r) (material diel))

	(make sphere (center 0.0842352941 0.3782352941 0.2942352941) (radius r) (material diel))

	(make sphere (center -0.3277647059 0.3782352941 -0.1177647059) (radius r) (material diel))

	(make sphere (center 0.5042352941 -0.2017647059 0.2942352941) (radius r) (material diel))

	(make sphere (center -0.4117647059 -0.4117647059 -0.4117647059) (radius r) (material diel))
))
