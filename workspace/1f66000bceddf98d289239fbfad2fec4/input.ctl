(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.80520242) (basis1 0.8660254038 -0.5 0.0) (basis2 0.8660254038 0.5 0.0) (basis3 0.0 0.0 2.805202418)))
(set! k-points (interpolate 1 (list
			...
			(vector3 -0.66666667 -0.33333333 0.0)			;V38
			...
			(vector3 0.33333333 0.66666667 0.5)			;V48
			...
			(vector3 0.5 0.0 0.5)			;V73
			(vector3 0.66666667 0.33333333 0.5)			;V74
			(vector3 0.66666667 0.33333333 -0.0)			;V75
...
(set! geometry (list (make sphere (center -0.3333333333 -0.3333333333 0.227) (radius r) (material diel))

	(make sphere (center -0.3333333333 -0.3333333333 -0.227) (radius r) (material diel))

	(make sphere (center 0.3336666667 0.3336666667 -0.44) (radius r) (material diel))

	(make sphere (center 0.3336666667 0.3336666667 0.106) (radius r) (material diel))

	(make sphere (center -0.0003333333 -0.0003333333 -0.106) (radius r) (material diel))

	(make sphere (center -0.0003333333 -0.0003333333 0.44) (radius r) (material diel))
))
