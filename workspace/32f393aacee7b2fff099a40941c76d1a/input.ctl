(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.06571429) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0657142912)))
...
(set! geometry (list (make sphere (center 0.03 0.37 0.25) (radius r) (material diel))

	(make sphere (center 0.97 0.63 0.75) (radius r) (material diel))

	(make sphere (center 0.63 0.66 0.25) (radius r) (material diel))

	(make sphere (center 0.37 0.34 0.75) (radius r) (material diel))

	(make sphere (center 0.34 0.97 0.25) (radius r) (material diel))

	(make sphere (center 0.66 0.03 0.75) (radius r) (material diel))
