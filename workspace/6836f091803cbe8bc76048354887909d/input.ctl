...
(set! geometry (list (make sphere (center -0.2272727273 -0.2272727273 -0.2272727273) (radius r) (material diel))

	(make sphere (center 0.2727272727 0.2727272727 0.2727272727) (radius r) (material diel))

	(make sphere (center -0.4772727273 -0.4772727273 -0.4772727273) (radius r) (material diel))

	(make sphere (center 0.0227272727 0.0227272727 0.0227272727) (radius r) (material diel))

	(make sphere (center 0.3317272727 -0.2862727273 0.3317272727) (radius r) (material diel))

	(make sphere (center -0.2862727273 -0.2862727273 0.3317272727) (radius r) (material diel))

	(make sphere (center -0.2862727273 0.3317272727 0.3317272727) (radius r) (material diel))

	(make sphere (center -0.2862727273 0.3317272727 -0.2862727273) (radius r) (material diel))

	(make sphere (center 0.3317272727 0.3317272727 -0.2862727273) (radius r) (material diel))

	(make sphere (center 0.3317272727 -0.2862727273 -0.2862727273) (radius r) (material diel))

	(make sphere (center -0.1222727273 -0.2982727273 0.1337272727) (radius r) (material diel))

	(make sphere (center -0.2982727273 0.3777272727 0.1337272727) (radius r) (material diel))

	(make sphere (center 0.3777272727 -0.1222727273 0.1337272727) (radius r) (material diel))

	(make sphere (center 0.3777272727 0.1337272727 -0.2982727273) (radius r) (material diel))

	(make sphere (center -0.1222727273 0.1337272727 0.3777272727) (radius r) (material diel))

	(make sphere (center -0.2982727273 0.1337272727 -0.1222727273) (radius r) (material diel))

	(make sphere (center 0.1337272727 0.3777272727 -0.1222727273) (radius r) (material diel))

	(make sphere (center 0.1337272727 -0.1222727273 -0.2982727273) (radius r) (material diel))

	(make sphere (center 0.1337272727 -0.2982727273 0.3777272727) (radius r) (material diel))

	(make sphere (center -0.2982727273 -0.1222727273 0.3777272727) (radius r) (material diel))

	(make sphere (center 0.3777272727 -0.2982727273 -0.1222727273) (radius r) (material diel))

	(make sphere (center -0.1222727273 0.3777272727 -0.2982727273) (radius r) (material diel))
))
