(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.02852615) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0285261517)))
...
(set! geometry (list (make sphere (center 0.3030303064 -0.3636363636 -0.3701818182) (radius r) (material diel))

	(make sphere (center -0.3636363636 0.3030303064 -0.3701818182) (radius r) (material diel))

	(make sphere (center -0.0303030336 -0.0303030336 -0.3701818182) (radius r) (material diel))

	(make sphere (center -0.0303030303 0.303030303 0.1658181818) (radius r) (material diel))

	(make sphere (center 0.303030303 -0.0303030303 0.1658181818) (radius r) (material diel))

	(make sphere (center -0.0303030336 -0.3636363636 0.4168181818) (radius r) (material diel))

	(make sphere (center -0.3636363636 -0.0303030336 0.4168181818) (radius r) (material diel))

	(make sphere (center 0.3030303064 0.3030303064 0.4168181818) (radius r) (material diel))

	(make sphere (center -0.0303030303 0.303030303 -0.1571818182) (radius r) (material diel))

	(make sphere (center 0.303030303 -0.0303030303 -0.1571818182) (radius r) (material diel))

	(make sphere (center -0.3636363636 -0.3636363636 -0.1571818182) (radius r) (material diel))
))
