...
(set! geometry (list (make sphere (center -0.1266666667 0.3733333333 -0.3266666667) (radius r) (material diel))

	(make sphere (center 0.0333333333 -0.1666666667 -0.3066666667) (radius r) (material diel))

	(make sphere (center -0.2666666667 0.3933333333 0.2333333333) (radius r) (material diel))

	(make sphere (center -0.1666666667 -0.3066666667 0.0333333333) (radius r) (material diel))

	(make sphere (center 0.3933333333 0.2333333333 -0.2666666667) (radius r) (material diel))

	(make sphere (center 0.3733333333 -0.3266666667 -0.1266666667) (radius r) (material diel))

	(make sphere (center 0.1933333333 0.3333333333 0.0333333333) (radius r) (material diel))

	(make sphere (center 0.0333333333 0.1933333333 0.3333333333) (radius r) (material diel))

	(make sphere (center 0.3333333333 0.0333333333 0.1933333333) (radius r) (material diel))

	(make sphere (center 0.2333333333 -0.2666666667 0.3933333333) (radius r) (material diel))

	(make sphere (center -0.3266666667 -0.1266666667 0.3733333333) (radius r) (material diel))

	(make sphere (center -0.3066666667 0.0333333333 -0.1666666667) (radius r) (material diel))

	(make sphere (center 0.1033333333 -0.3366666667 -0.1866666667) (radius r) (material diel))

	(make sphere (center -0.0266666667 -0.3166666667 0.4033333333) (radius r) (material diel))

	(make sphere (center -0.1766666667 0.2533333333 0.3833333333) (radius r) (material diel))

	(make sphere (center -0.3166666667 0.4033333333 -0.0266666667) (radius r) (material diel))

	(make sphere (center 0.2533333333 0.3833333333 -0.1766666667) (radius r) (material diel))

	(make sphere (center -0.3366666667 -0.1866666667 0.1033333333) (radius r) (material diel))

	(make sphere (center -0.0366666667 0.2433333333 0.0933333333) (radius r) (material diel))

	(make sphere (center 0.0933333333 -0.0366666667 0.2433333333) (radius r) (material diel))

	(make sphere (center 0.2433333333 0.0933333333 -0.0366666667) (radius r) (material diel))

	(make sphere (center 0.3833333333 -0.1766666667 0.2533333333) (radius r) (material diel))

	(make sphere (center -0.1866666667 0.1033333333 -0.3366666667) (radius r) (material diel))

	(make sphere (center 0.4033333333 -0.0266666667 -0.3166666667) (radius r) (material diel))

	(make sphere (center -0.2766666667 -0.4666666667 -0.2766666667) (radius r) (material diel))

	(make sphere (center -0.2766666667 -0.2766666667 -0.4666666667) (radius r) (material diel))

	(make sphere (center -0.4666666667 0.3433333333 0.3433333333) (radius r) (material diel))

	(make sphere (center 0.3433333333 0.3433333333 -0.4666666667) (radius r) (material diel))

	(make sphere (center -0.4666666667 -0.2766666667 -0.2766666667) (radius r) (material diel))

	(make sphere (center 0.3433333333 -0.4666666667 0.3433333333) (radius r) (material diel))
))
