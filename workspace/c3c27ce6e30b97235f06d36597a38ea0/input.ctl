(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.69145771) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.6914577128)))
...
(set! geometry (list (make sphere (center -0.4166666667 -0.4166666667 -0.4583333333) (radius r) (material diel))
	...
	(make sphere (center -0.4166666667 -0.4166666667 0.0416666667) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.2363333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.3196666667) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.4423333333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.5256666667) (radius r) (material diel))

	(make sphere (center -0.0886666667 -0.0726666667 -0.1413333333) (radius r) (material diel))

	(make sphere (center 0.2393333333 0.5673333333 -0.1413333333) (radius r) (material diel))

	(make sphere (center -0.4006666667 0.2553333333 -0.1413333333) (radius r) (material diel))

	(make sphere (center -0.0726666667 -0.0886666667 0.2246666667) (radius r) (material diel))

	(make sphere (center 0.2553333333 -0.4006666667 0.2246666667) (radius r) (material diel))

	(make sphere (center 0.5673333333 0.2393333333 0.2246666667) (radius r) (material diel))
))
