...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.88519948) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.8851994787)))
...
(set! geometry (list (make sphere (center 0.555 0.987 0.632) (radius r) (material diel))

	(make sphere (center 0.445 0.013 0.368) (radius r) (material diel))

	(make sphere (center 0.013 0.568 0.632) (radius r) (material diel))

	(make sphere (center 0.987 0.432 0.368) (radius r) (material diel))

	(make sphere (center 0.432 0.445 0.632) (radius r) (material diel))

	(make sphere (center 0.568 0.555 0.368) (radius r) (material diel))

	(make sphere (center 0.445 0.013 0.132) (radius r) (material diel))

	(make sphere (center 0.555 0.987 0.868) (radius r) (material diel))

	(make sphere (center 0.987 0.432 0.132) (radius r) (material diel))

	(make sphere (center 0.013 0.568 0.868) (radius r) (material diel))

	(make sphere (center 0.568 0.555 0.132) (radius r) (material diel))

	(make sphere (center 0.432 0.445 0.868) (radius r) (material diel))

	(make sphere (center 0.788 0.567 0.082) (radius r) (material diel))

	(make sphere (center 0.212 0.433 0.918) (radius r) (material diel))

	(make sphere (center 0.433 0.221 0.082) (radius r) (material diel))

	(make sphere (center 0.567 0.779 0.918) (radius r) (material diel))

	(make sphere (center 0.779 0.212 0.082) (radius r) (material diel))

	(make sphere (center 0.221 0.788 0.918) (radius r) (material diel))

	(make sphere (center 0.212 0.433 0.582) (radius r) (material diel))

	(make sphere (center 0.788 0.567 0.418) (radius r) (material diel))

	(make sphere (center 0.567 0.779 0.582) (radius r) (material diel))

	(make sphere (center 0.433 0.221 0.418) (radius r) (material diel))

	(make sphere (center 0.221 0.788 0.582) (radius r) (material diel))

	(make sphere (center 0.779 0.212 0.418) (radius r) (material diel))
))
