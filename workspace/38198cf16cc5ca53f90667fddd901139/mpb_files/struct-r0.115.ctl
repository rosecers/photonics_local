...
(set! geometry (list (make sphere (center 0.1944444444 0.1944444444 0.1944444444) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 0.2574444444 0.0694444444) (radius r) (material diel))
	(make sphere (center -0.4305555556 -0.1185555556 -0.4305555556) (radius r) (material diel))
	(make sphere (center 0.115694444444 0.3824444444 -0.4305555556) (radius r) (material diel))
	(make sphere (center -0.4305555556 -0.2435555556 0.0694444444) (radius r) (material diel))
	(make sphere (center 0.115694444444 0.0694444444 0.2574444444) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 -0.4305555556 -0.2435555556) (radius r) (material diel))
	...
	(make sphere (center 0.115064444444 0.3194444444 -0.1805555556) (radius r) (material diel))
	...
	(make sphere (center 0.115064444444 -0.1805555556 0.3194444444) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 -0.2435555556 -0.4305555556) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 -0.4305555556 0.3824444444) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 -0.1185555556 0.0694444444) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 0.0694444444 -0.1185555556) (radius r) (material diel))
	...
	(make sphere (center 0.115694444444 0.0694444444 -0.4305555556) (radius r) (material diel))
	(make sphere (center 0.115694444444 -0.4305555556 0.0694444444) (radius r) (material diel))
