(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.03994927) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.0399492717)))
...
(set! geometry (list (make sphere (center -0.0606666667 -0.3886666667 -0.404) (radius r) (material diel))

	(make sphere (center 0.5553333333 -0.0886666667 -0.404) (radius r) (material diel))

	(make sphere (center 0.2553333333 0.2273333333 -0.404) (radius r) (material diel))

	(make sphere (center -0.3886666667 -0.0606666667 -0.096) (radius r) (material diel))

	(make sphere (center 0.2273333333 0.2553333333 -0.096) (radius r) (material diel))

	(make sphere (center -0.0886666667 0.5553333333 -0.096) (radius r) (material diel))

	(make sphere (center 0.2273333333 0.5553333333 0.404) (radius r) (material diel))

	(make sphere (center -0.3886666667 0.2553333333 0.404) (radius r) (material diel))

	(make sphere (center -0.0886666667 -0.0606666667 0.404) (radius r) (material diel))

	(make sphere (center 0.5553333333 0.2273333333 0.096) (radius r) (material diel))

	(make sphere (center -0.0606666667 -0.0886666667 0.096) (radius r) (material diel))

	(make sphere (center 0.2553333333 -0.3886666667 0.096) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 -0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.4166666667 0.25) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 -0.333) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 -0.167) (radius r) (material diel))

	(make sphere (center 0.25 -0.0833333333 0.333) (radius r) (material diel))

	(make sphere (center -0.0833333333 0.25 0.167) (radius r) (material diel))

	(make sphere (center 0.2500000033 -0.4166666667 -0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 0.2500000033 -0.25) (radius r) (material diel))

	(make sphere (center -0.0833333367 -0.0833333367 -0.25) (radius r) (material diel))

	(make sphere (center -0.0833333367 -0.4166666667 0.25) (radius r) (material diel))

	(make sphere (center -0.4166666667 -0.0833333367 0.25) (radius r) (material diel))

	(make sphere (center 0.2500000033 0.2500000033 0.25) (radius r) (material diel))
))
