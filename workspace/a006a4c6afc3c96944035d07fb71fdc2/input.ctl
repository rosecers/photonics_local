...
(set! geometry (list (make sphere (center 0.273 0.024 0.854) (radius r) (material diel))
	...
	(make sphere (center 0.022 0.168 0.75) (radius r) (material diel))
	...
	(make sphere (center 0.087 0.503 0.295) (radius r) (material diel))
	...
	(make sphere (center 0.099 0.781 0.105) (radius r) (material diel))
