...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.87518697) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.8751869747)))
...
(set! geometry (list (make sphere (center -0.3611333333 -0.3055666667 -0.4583333333) (radius r) (material diel))

	(make sphere (center 0.3055666667 -0.3055666667 0.2083333333) (radius r) (material diel))

	(make sphere (center 0.3055666667 0.3611333333 -0.125) (radius r) (material diel))

	(make sphere (center 0.3055666667 0.0277833333 -0.4583333333) (radius r) (material diel))

	(make sphere (center -0.0277833333 0.0277833333 0.2083333333) (radius r) (material diel))

	(make sphere (center -0.0277833333 -0.3055666667 -0.125) (radius r) (material diel))

	(make sphere (center 0.3055666667 -0.3055666667 -0.3852333333) (radius r) (material diel))

	(make sphere (center 0.3055666667 0.3611333333 0.2814333333) (radius r) (material diel))

	(make sphere (center -0.3611333333 -0.3055666667 -0.0519) (radius r) (material diel))

	(make sphere (center 0.3055666667 -0.3055666667 -0.1981) (radius r) (material diel))

	(make sphere (center -0.3611333333 -0.3055666667 0.1352333333) (radius r) (material diel))

	(make sphere (center 0.3055666667 0.3611333333 0.4685666667) (radius r) (material diel))

	(make sphere (center -0.0277333333 0.0277333333 -0.3852333333) (radius r) (material diel))

	(make sphere (center -0.0277333333 -0.3054666667 0.2814333333) (radius r) (material diel))

	(make sphere (center 0.3054666667 0.0277333333 -0.0519) (radius r) (material diel))

	(make sphere (center -0.0277333333 0.0277333333 -0.1981) (radius r) (material diel))

	(make sphere (center 0.3054666667 0.0277333333 0.1352333333) (radius r) (material diel))

	(make sphere (center -0.0277333333 -0.3054666667 0.4685666667) (radius r) (material diel))

	(make sphere (center -0.3611333333 0.3611333333 -0.3852333333) (radius r) (material diel))

	(make sphere (center -0.3611333333 0.0277333333 0.2814333333) (radius r) (material diel))

	(make sphere (center -0.0277333333 0.3611333333 -0.0519) (radius r) (material diel))

	(make sphere (center -0.3611333333 0.3611333333 -0.1981) (radius r) (material diel))

	(make sphere (center -0.0277333333 0.3611333333 0.1352333333) (radius r) (material diel))

	(make sphere (center -0.3611333333 0.0277333333 0.4685666667) (radius r) (material diel))
))
