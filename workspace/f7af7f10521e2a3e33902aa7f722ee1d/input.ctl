...
(set! geometry (list (make sphere (center 0.2678571429 0.2678571429 0.2678571429) (radius r) (material diel))

	(make sphere (center -0.2321428571 -0.2321428571 -0.2321428571) (radius r) (material diel))

	(make sphere (center 0.0178571429 0.0178571429 0.0178571429) (radius r) (material diel))

	(make sphere (center -0.4821428571 -0.4821428571 -0.4821428571) (radius r) (material diel))

	(make sphere (center -0.0381428571 -0.2821428571 0.0738571429) (radius r) (material diel))

	(make sphere (center 0.0738571429 0.3178571429 -0.0381428571) (radius r) (material diel))

	(make sphere (center 0.3178571429 0.0738571429 -0.2821428571) (radius r) (material diel))

	(make sphere (center -0.2821428571 -0.0381428571 0.3178571429) (radius r) (material diel))

	(make sphere (center 0.3178571429 -0.2821428571 -0.0381428571) (radius r) (material diel))

	(make sphere (center -0.2821428571 0.3178571429 0.0738571429) (radius r) (material diel))

	(make sphere (center -0.0381428571 0.0738571429 0.3178571429) (radius r) (material diel))

	(make sphere (center 0.0738571429 -0.0381428571 -0.2821428571) (radius r) (material diel))

	(make sphere (center 0.0738571429 -0.2821428571 0.3178571429) (radius r) (material diel))

	(make sphere (center -0.0381428571 0.3178571429 -0.2821428571) (radius r) (material diel))

	(make sphere (center -0.2821428571 0.0738571429 -0.0381428571) (radius r) (material diel))

	(make sphere (center 0.3178571429 -0.0381428571 0.0738571429) (radius r) (material diel))

	(make sphere (center -0.4261428571 0.4618571429 -0.1821428571) (radius r) (material diel))

	(make sphere (center 0.4618571429 -0.4261428571 0.2178571429) (radius r) (material diel))

	(make sphere (center 0.2178571429 -0.1821428571 0.4618571429) (radius r) (material diel))

	(make sphere (center -0.1821428571 0.2178571429 -0.4261428571) (radius r) (material diel))

	(make sphere (center 0.2178571429 -0.4261428571 -0.1821428571) (radius r) (material diel))

	(make sphere (center -0.1821428571 0.4618571429 0.2178571429) (radius r) (material diel))

	(make sphere (center -0.4261428571 0.2178571429 0.4618571429) (radius r) (material diel))

	(make sphere (center 0.4618571429 -0.1821428571 -0.4261428571) (radius r) (material diel))

	(make sphere (center 0.4618571429 0.2178571429 -0.1821428571) (radius r) (material diel))

	(make sphere (center -0.4261428571 -0.1821428571 0.2178571429) (radius r) (material diel))

	(make sphere (center -0.1821428571 -0.4261428571 0.4618571429) (radius r) (material diel))

	(make sphere (center 0.2178571429 0.4618571429 -0.4261428571) (radius r) (material diel))
))
