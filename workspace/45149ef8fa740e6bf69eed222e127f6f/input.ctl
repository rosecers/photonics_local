...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.68277234) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254037919487 0.0) (basis3 0.0 0.0 0.6827723390429994)))
...
(set! geometry (list (make sphere (center 0.0 0.0 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.6 0.0 0.25) (radius r) (material diel))

	(make sphere (center 0.4 0.0 0.75) (radius r) (material diel))

	(make sphere (center 0.0 0.6 0.25) (radius r) (material diel))

	(make sphere (center 0.0 0.4 0.75) (radius r) (material diel))

	(make sphere (center 0.4 0.4 0.25) (radius r) (material diel))

	(make sphere (center 0.6 0.6 0.75) (radius r) (material diel))
	...
	(make sphere (center 0.27 0.0 0.25) (radius r) (material diel))

	(make sphere (center 0.73 0.0 0.75) (radius r) (material diel))

	(make sphere (center 0.0 0.27 0.25) (radius r) (material diel))

	(make sphere (center 0.0 0.73 0.75) (radius r) (material diel))

	(make sphere (center 0.73 0.73 0.25) (radius r) (material diel))

	(make sphere (center 0.27 0.27 0.75) (radius r) (material diel))
))
