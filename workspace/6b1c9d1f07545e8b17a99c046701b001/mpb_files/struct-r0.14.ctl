...
(set! geometry (list (make sphere (center 0.2613577778 0.4711377778 -0.1889111111) (radius r) (material diel))
	...
	(make sphere (center 0.14844177778 0.2941977778 0.3110888889) (radius r) (material diel))
	...
	(make sphere (center 0.14277777778 0.0277777778 -0.3234111111) (radius r) (material diel))
	...
	(make sphere (center 0.14916777778 0.2354777778 -0.1864111111) (radius r) (material diel))
	...
	(make sphere (center 0.14277777778 0.0277777778 0.3195888889) (radius r) (material diel))
))
