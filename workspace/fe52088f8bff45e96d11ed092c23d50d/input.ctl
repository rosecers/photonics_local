...
(set! geometry (list (make sphere (center -0.4772727273 -0.4772727273 -0.4772727273) (radius r) (material diel))

	(make sphere (center 0.3277272727 -0.2822727273 -0.2822727273) (radius r) (material diel))

	(make sphere (center 0.3277272727 0.3277272727 -0.2822727273) (radius r) (material diel))

	(make sphere (center 0.3277272727 -0.2822727273 0.3277272727) (radius r) (material diel))

	(make sphere (center -0.2822727273 0.3277272727 0.3277272727) (radius r) (material diel))

	(make sphere (center -0.2822727273 -0.2822727273 0.3277272727) (radius r) (material diel))

	(make sphere (center -0.2822727273 0.3277272727 -0.2822727273) (radius r) (material diel))

	(make sphere (center -0.2272727273 -0.2272727273 -0.2272727273) (radius r) (material diel))

	(make sphere (center 0.2727272727 0.2727272727 0.2727272727) (radius r) (material diel))

	(make sphere (center 0.0227272727 0.0227272727 0.0227272727) (radius r) (material diel))

	(make sphere (center 0.1877272727 -0.3422727273 0.3877272727) (radius r) (material diel))

	(make sphere (center 0.1877272727 -0.1422727273 -0.3422727273) (radius r) (material diel))

	(make sphere (center 0.1877272727 0.3877272727 -0.1422727273) (radius r) (material diel))

	(make sphere (center -0.1422727273 0.3877272727 -0.3422727273) (radius r) (material diel))

	(make sphere (center -0.1422727273 0.1877272727 0.3877272727) (radius r) (material diel))

	(make sphere (center -0.1422727273 -0.3422727273 0.1877272727) (radius r) (material diel))

	(make sphere (center 0.3877272727 -0.3422727273 -0.1422727273) (radius r) (material diel))

	(make sphere (center -0.3422727273 -0.1422727273 0.3877272727) (radius r) (material diel))

	(make sphere (center -0.3422727273 0.3877272727 0.1877272727) (radius r) (material diel))

	(make sphere (center 0.3877272727 0.1877272727 -0.3422727273) (radius r) (material diel))

	(make sphere (center 0.3877272727 -0.1422727273 0.1877272727) (radius r) (material diel))

	(make sphere (center -0.3422727273 0.1877272727 -0.1422727273) (radius r) (material diel))
))
