(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.69703207) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254037815772 0.0) (basis3 0.0 0.0 0.6970320722124234)))
(set! k-points (interpolate 1 (list
			...
			(vector3 0.33333333 -0.66666667 0.0)			;V27
...
(set! geometry (list (make sphere (center 0.3333333333333333 0.6666666666666666 0.0) (radius r) (material diel))
	...
	(make sphere (center 0.23459 0.0 0.25) (radius r) (material diel))

	(make sphere (center 0.76541 0.0 0.75) (radius r) (material diel))

	(make sphere (center 0.0 0.23459 0.25) (radius r) (material diel))

	(make sphere (center 0.0 0.76541 0.75) (radius r) (material diel))

	(make sphere (center 0.76541 0.76541 0.25) (radius r) (material diel))

	(make sphere (center 0.23459 0.23459 0.75) (radius r) (material diel))

	(make sphere (center 0.59779 0.0 0.25) (radius r) (material diel))

	(make sphere (center 0.40221 0.0 0.75) (radius r) (material diel))

	(make sphere (center 0.0 0.59779 0.25) (radius r) (material diel))

	(make sphere (center 0.0 0.40221 0.75) (radius r) (material diel))

	(make sphere (center 0.40221 0.40221 0.25) (radius r) (material diel))

	(make sphere (center 0.59779 0.59779 0.75) (radius r) (material diel))
))
