...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.58168072) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254037827098 0.0) (basis3 0.0 0.0 1.5816807169957532)))
...
(set! geometry (list (make sphere (center 0.0 0.0 0.25) (radius r) (material diel))
	...
	(make sphere (center 0.3333333333333333 0.6666666666666666 0.452) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.548) (radius r) (material diel))

	(make sphere (center 0.6666666666666666 0.3333333333333333 0.952) (radius r) (material diel))

	(make sphere (center 0.3333333333333333 0.6666666666666666 0.048) (radius r) (material diel))
))
