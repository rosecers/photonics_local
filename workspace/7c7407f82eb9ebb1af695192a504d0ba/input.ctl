...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.78268311) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.7826831146)))
...
(set! geometry (list (make sphere (center -0.3472222222 -0.0277777811 0.421) (radius r) (material diel))

	(make sphere (center 0.3194444478 0.3055555589 0.421) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.3611111111 0.421) (radius r) (material diel))

	(make sphere (center 0.3194444478 -0.3611111111 -0.421) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.0277777811 -0.421) (radius r) (material diel))

	(make sphere (center -0.3472222222 0.3055555589 -0.421) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.0277777811 0.246) (radius r) (material diel))

	(make sphere (center 0.3194444478 -0.3611111111 0.246) (radius r) (material diel))

	(make sphere (center -0.3472222222 0.3055555589 0.246) (radius r) (material diel))

	(make sphere (center 0.3194444478 0.3055555589 -0.246) (radius r) (material diel))

	(make sphere (center -0.3472222222 -0.0277777811 -0.246) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.3611111111 -0.246) (radius r) (material diel))

	(make sphere (center -0.3472222222 -0.0277777811 0.088) (radius r) (material diel))

	(make sphere (center 0.3194444478 0.3055555589 0.088) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.3611111111 0.088) (radius r) (material diel))

	(make sphere (center 0.3194444478 -0.3611111111 -0.088) (radius r) (material diel))

	(make sphere (center -0.0138888922 -0.0277777811 -0.088) (radius r) (material diel))

	(make sphere (center -0.3472222222 0.3055555589 -0.088) (radius r) (material diel))

	(make sphere (center -0.3472222222 -0.3611111111 -0.0) (radius r) (material diel))

	(make sphere (center -0.0138888889 0.3055555556 -0.0) (radius r) (material diel))

	(make sphere (center 0.3194444444 -0.0277777778 0.3333) (radius r) (material diel))

	(make sphere (center 0.3194444444 -0.0277777778 -0.3333) (radius r) (material diel))

	(make sphere (center -0.0138888889 0.3055555556 0.3333) (radius r) (material diel))
