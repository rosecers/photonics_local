(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.91991962) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.9199196193)))
...
(set! geometry (list (make sphere (center 0.5424 0.0 0.8333) (radius r) (material diel))

	(make sphere (center 0.0 0.5424 0.1667) (radius r) (material diel))

	(make sphere (center 0.4576 0.4576 0.5) (radius r) (material diel))

	(make sphere (center 0.5481 0.0 0.3333) (radius r) (material diel))

	(make sphere (center 0.0 0.5481 0.6667) (radius r) (material diel))

	(make sphere (center 0.4519 0.4519 0.0) (radius r) (material diel))

	(make sphere (center 0.3693 0.8731 0.1897) (radius r) (material diel))

	(make sphere (center 0.1269 0.4962 0.523) (radius r) (material diel))

	(make sphere (center 0.5038 0.6307 0.8564) (radius r) (material diel))

	(make sphere (center 0.8731 0.3693 0.8103) (radius r) (material diel))

	(make sphere (center 0.4962 0.1269 0.477) (radius r) (material diel))

	(make sphere (center 0.6307 0.5038 0.1436) (radius r) (material diel))

	(make sphere (center 0.5952 0.8564 0.4656) (radius r) (material diel))

	(make sphere (center 0.1436 0.7388 0.7989) (radius r) (material diel))

	(make sphere (center 0.2612 0.4048 0.1323) (radius r) (material diel))

	(make sphere (center 0.8564 0.5952 0.5344) (radius r) (material diel))

	(make sphere (center 0.7388 0.1436 0.2011) (radius r) (material diel))

	(make sphere (center 0.4048 0.2612 0.8677) (radius r) (material diel))

	(make sphere (center 0.9143 0.0 0.8333) (radius r) (material diel))

	(make sphere (center 0.0 0.9143 0.1667) (radius r) (material diel))

	(make sphere (center 0.0857 0.0857 0.5) (radius r) (material diel))
))
