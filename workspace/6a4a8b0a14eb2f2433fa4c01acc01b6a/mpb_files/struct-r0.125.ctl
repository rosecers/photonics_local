...
(set! geometry (list (make sphere (center 0.1949 0.3545 0.5995) (radius r) (material diel))
	...
	(make sphere (center 0.125032 0.2681 0.6901) (radius r) (material diel))
	...
	(make sphere (center 0.125 0.5 0.5795) (radius r) (material diel))
	(make sphere (center 0.5 0.0 0.4205) (radius r) (material diel))
	(make sphere (center 0.5 0.0 0.9205) (radius r) (material diel))
	(make sphere (center 0.125 0.5 0.0795) (radius r) (material diel))
	(make sphere (center 0.1255995 0.34983 0.57965) (radius r) (material diel))
	...
	(make sphere (center 0.1258823 0.86299 0.86794) (radius r) (material diel))
	...
	(make sphere (center 0.125 0.0 0.0) (radius r) (material diel))
