...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.7430964) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.7430964045)))
...
(set! geometry (list (make sphere (center -0.4 -0.4 -0.1417) (radius r) (material diel))

	(make sphere (center -0.4 -0.4 0.3583) (radius r) (material diel))

	(make sphere (center -0.4 -0.4 0.1417) (radius r) (material diel))

	(make sphere (center -0.4 -0.4 -0.3583) (radius r) (material diel))

	(make sphere (center -0.0666666667 0.2666666667 -0.4877) (radius r) (material diel))

	(make sphere (center -0.0666666667 0.2666666667 0.0123) (radius r) (material diel))

	(make sphere (center 0.2666666667 -0.0666666667 0.4877) (radius r) (material diel))

	(make sphere (center 0.2666666667 -0.0666666667 -0.0123) (radius r) (material diel))

	(make sphere (center -0.0666666667 0.2666666667 -0.1925) (radius r) (material diel))

	(make sphere (center -0.0666666667 0.2666666667 0.3075) (radius r) (material diel))

	(make sphere (center 0.2666666667 -0.0666666667 0.1925) (radius r) (material diel))

	(make sphere (center 0.2666666667 -0.0666666667 -0.3075) (radius r) (material diel))

	(make sphere (center -0.056 -0.079 -0.415) (radius r) (material diel))

	(make sphere (center 0.279 -0.377 -0.415) (radius r) (material diel))

	(make sphere (center 0.577 0.256 -0.415) (radius r) (material diel))

	(make sphere (center 0.279 0.256 0.085) (radius r) (material diel))

	(make sphere (center -0.056 -0.377 0.085) (radius r) (material diel))

	(make sphere (center 0.577 -0.079 0.085) (radius r) (material diel))

	(make sphere (center 0.256 0.279 0.415) (radius r) (material diel))

	(make sphere (center -0.079 0.577 0.415) (radius r) (material diel))

	(make sphere (center -0.377 -0.056 0.415) (radius r) (material diel))

	(make sphere (center -0.079 -0.056 -0.085) (radius r) (material diel))

	(make sphere (center 0.256 0.577 -0.085) (radius r) (material diel))

	(make sphere (center -0.377 0.279 -0.085) (radius r) (material diel))

	(make sphere (center -0.112 -0.4 -0.25) (radius r) (material diel))

	(make sphere (center -0.4 -0.112 -0.25) (radius r) (material diel))

	(make sphere (center 0.312 0.312 -0.25) (radius r) (material diel))

	(make sphere (center -0.4 0.312 0.25) (radius r) (material diel))

	(make sphere (center -0.112 -0.112 0.25) (radius r) (material diel))

	(make sphere (center 0.312 -0.4 0.25) (radius r) (material diel))
))
