...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.09592365) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.0959236534)))
...
(set! geometry (list (make sphere (center -0.45 -0.45 -0.25) (radius r) (material diel))
	...
	(make sphere (center -0.1166666667 0.2166666667 -0.3359) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 0.1641) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 0.3359) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 -0.1641) (radius r) (material diel))

	(make sphere (center -0.1355 -0.1072 -0.38027) (radius r) (material diel))

	(make sphere (center 0.2072 0.5217 -0.38027) (radius r) (material diel))

	(make sphere (center -0.4217 0.2355 -0.38027) (radius r) (material diel))

	(make sphere (center -0.1072 -0.1355 0.11973) (radius r) (material diel))

	(make sphere (center 0.2355 -0.4217 0.11973) (radius r) (material diel))

	(make sphere (center 0.5217 0.2072 0.11973) (radius r) (material diel))

	(make sphere (center 0.2355 0.2072 0.38027) (radius r) (material diel))

	(make sphere (center -0.1072 -0.4217 0.38027) (radius r) (material diel))

	(make sphere (center 0.5217 -0.1355 0.38027) (radius r) (material diel))

	(make sphere (center 0.2072 0.2355 -0.11973) (radius r) (material diel))

	(make sphere (center -0.1355 0.5217 -0.11973) (radius r) (material diel))

	(make sphere (center -0.4217 -0.1072 -0.11973) (radius r) (material diel))
))
