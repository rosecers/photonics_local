...
(set! geometry (list (make sphere (center -0.3928571429 0.1071428571 -0.3928571429) (radius r) (material diel))
	...
	(make sphere (center 0.3651428571 -0.1668571429 0.3651428571) (radius r) (material diel))

	(make sphere (center -0.1508571429 0.3811428571 -0.1508571429) (radius r) (material diel))

	(make sphere (center 0.3651428571 0.3651428571 0.3651428571) (radius r) (material diel))

	(make sphere (center -0.1508571429 -0.1508571429 -0.1508571429) (radius r) (material diel))

	(make sphere (center -0.1668571429 0.3651428571 0.3651428571) (radius r) (material diel))

	(make sphere (center 0.3811428571 -0.1508571429 -0.1508571429) (radius r) (material diel))

	(make sphere (center 0.3651428571 0.3651428571 -0.1668571429) (radius r) (material diel))

	(make sphere (center -0.1508571429 -0.1508571429 0.3811428571) (radius r) (material diel))
