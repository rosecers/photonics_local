...
(set! geometry (list (make sphere (center 0.06 0.87581 0.0) (radius r) (material diel))
	(make sphere (center 0.06 0.12419 0.0) (radius r) (material diel))
	(make sphere (center 0.06 0.0 0.87581) (radius r) (material diel))
	(make sphere (center 0.06 0.0 0.12419) (radius r) (material diel))
	...
	(make sphere (center 0.06011 0.87558 0.75305) (radius r) (material diel))
	(make sphere (center 0.06011 0.12442 0.24695) (radius r) (material diel))
	...
	(make sphere (center 0.06011 0.75305 0.87558) (radius r) (material diel))
	(make sphere (center 0.06011 0.24695 0.12442) (radius r) (material diel))
	...
	(make sphere (center 0.066225 0.06225 0.06225) (radius r) (material diel))
	(make sphere (center 0.066225 0.93775 0.93775) (radius r) (material diel))
	...
	(make sphere (center 0.066123 0.1861 0.93877) (radius r) (material diel))
	(make sphere (center 0.066123 0.8139 0.06123) (radius r) (material diel))
	...
	(make sphere (center 0.066123 0.06123 0.8139) (radius r) (material diel))
	(make sphere (center 0.066123 0.93877 0.1861) (radius r) (material diel))
	...
	(make sphere (center 0.06655 0.8122 0.8122) (radius r) (material diel))
	(make sphere (center 0.06655 0.1878 0.1878) (radius r) (material diel))
	...
	(make sphere (center 0.06607 0.6881 0.9393) (radius r) (material diel))
	...
	(make sphere (center 0.06607 0.3119 0.0607) (radius r) (material diel))
	...
	(make sphere (center 0.06607 0.9393 0.6881) (radius r) (material diel))
	(make sphere (center 0.06607 0.0607 0.3119) (radius r) (material diel))
	...
	(make sphere (center 0.06617 0.1895 0.694) (radius r) (material diel))
	(make sphere (center 0.06617 0.8105 0.306) (radius r) (material diel))
	...
	(make sphere (center 0.06617 0.694 0.1895) (radius r) (material diel))
	(make sphere (center 0.06617 0.306 0.8105) (radius r) (material diel))
