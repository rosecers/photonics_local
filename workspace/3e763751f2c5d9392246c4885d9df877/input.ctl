...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.66867143) (basis1 0.8660254038 -0.5 0.0) (basis2 0.8660254038 0.5 0.0) (basis3 0.0 0.0 1.6686714336)))
...
(set! geometry (list (make sphere (center 0.1333333333 0.1333333333 0.1252666667) (radius r) (material diel))

	(make sphere (center -0.1996666667 -0.1996666667 0.4582666667) (radius r) (material diel))

	(make sphere (center 0.4663333333 0.4663333333 -0.2077333333) (radius r) (material diel))

	(make sphere (center 0.1333333333 0.1333333333 0.5302666667) (radius r) (material diel))

	(make sphere (center -0.1996666667 -0.1996666667 -0.1367333333) (radius r) (material diel))

	(make sphere (center 0.4663333333 0.4663333333 0.1972666667) (radius r) (material diel))

	(make sphere (center 0.2643333333 0.2643333333 -0.4407333333) (radius r) (material diel))

	(make sphere (center -0.1286666667 0.2643333333 -0.4407333333) (radius r) (material diel))

	(make sphere (center 0.2643333333 -0.1286666667 -0.4407333333) (radius r) (material diel))

	(make sphere (center -0.0686666667 -0.0686666667 -0.1077333333) (radius r) (material diel))

	(make sphere (center -0.4616666667 -0.0686666667 -0.1077333333) (radius r) (material diel))

	(make sphere (center -0.0686666667 -0.4616666667 -0.1077333333) (radius r) (material diel))

	(make sphere (center -0.4026666667 -0.4026666667 0.2262666667) (radius r) (material diel))

	(make sphere (center 0.2043333333 -0.4026666667 0.2262666667) (radius r) (material diel))

	(make sphere (center -0.4026666667 0.2043333333 0.2262666667) (radius r) (material diel))
))
