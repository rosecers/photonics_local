...
(set! geometry (list (make sphere (center 0.0773636364 0.4453636364 0.4453636364) (radius r) (material diel))

	(make sphere (center 0.0773636364 0.4453636364 0.0773636364) (radius r) (material diel))

	(make sphere (center 0.0773636364 0.0773636364 0.4453636364) (radius r) (material diel))

	(make sphere (center 0.4453636364 0.0773636364 0.4453636364) (radius r) (material diel))

	(make sphere (center 0.4453636364 0.4453636364 0.0773636364) (radius r) (material diel))

	(make sphere (center 0.4453636364 0.0773636364 0.0773636364) (radius r) (material diel))

	(make sphere (center 0.1953636364 -0.1726363636 -0.1726363636) (radius r) (material diel))

	(make sphere (center 0.1953636364 -0.1726363636 0.1953636364) (radius r) (material diel))

	(make sphere (center 0.1953636364 0.1953636364 -0.1726363636) (radius r) (material diel))

	(make sphere (center -0.1726363636 0.1953636364 -0.1726363636) (radius r) (material diel))

	(make sphere (center -0.1726363636 -0.1726363636 0.1953636364) (radius r) (material diel))

	(make sphere (center -0.1726363636 0.1953636364 0.1953636364) (radius r) (material diel))

	(make sphere (center -0.2386363636 -0.2386363636 -0.2386363636) (radius r) (material diel))

	(make sphere (center -0.4886363636 -0.4886363636 -0.4886363636) (radius r) (material diel))
	...
	(make sphere (center -0.3636363636 -0.3636363636 -0.3636363636) (radius r) (material diel))
