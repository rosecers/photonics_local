...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.20051832) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.200518322)))
...
(set! geometry (list (make sphere (center -0.25 -0.25 0.404075) (radius r) (material diel))

	(make sphere (center 0.0833333333 0.4166666667 -0.466225) (radius r) (material diel))

	(make sphere (center -0.25 -0.25 0.073275) (radius r) (material diel))

	(make sphere (center 0.4166666667 0.0833333333 -0.011125) (radius r) (material diel))
))
