...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.93127842) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.9312784232)))
...
(set! geometry (list (make sphere (center -0.1166666667 0.2166666667 -0.175) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 0.325) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 -0.425) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 0.075) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.1166666667 -0.425) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.2166666667 0.075) (radius r) (material diel))

	(make sphere (center -0.45 -0.45 -0.425) (radius r) (material diel))

	(make sphere (center -0.45 -0.45 0.075) (radius r) (material diel))

	(make sphere (center -0.1166666667 0.5499999967 -0.3) (radius r) (material diel))

	(make sphere (center -0.1166666633 -0.4499999967 0.2) (radius r) (material diel))

	(make sphere (center 0.5499999967 0.2166666633 0.45) (radius r) (material diel))

	(make sphere (center -0.4499999967 0.2166666667 -0.05) (radius r) (material diel))

	(make sphere (center 0.2166666633 0.2166666667 -0.3) (radius r) (material diel))

	(make sphere (center 0.2166666667 0.2166666633 0.2) (radius r) (material diel))

	(make sphere (center 0.2166666667 -0.4499999967 0.45) (radius r) (material diel))

	(make sphere (center 0.2166666633 0.5499999967 -0.05) (radius r) (material diel))

	(make sphere (center -0.4499999967 -0.1166666633 -0.3) (radius r) (material diel))

	(make sphere (center 0.5499999967 -0.1166666667 0.2) (radius r) (material diel))

	(make sphere (center -0.1166666633 -0.1166666667 0.45) (radius r) (material diel))

	(make sphere (center -0.1166666667 -0.1166666633 -0.05) (radius r) (material diel))
))
