...
(set! geometry-lattice (make lattice (basis-size 1.0 1.0 1.90753703) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 1.9075370331)))
...
(set! geometry (list (make sphere (center -0.4375 -0.4375 0.25) (radius r) (material diel))
	...
	(make sphere (center 0.2291666667 -0.1041666667 0.25) (radius r) (material diel))

	(make sphere (center -0.1041666667 0.2291666667 -0.25) (radius r) (material diel))

	(make sphere (center 0.5544 -0.1105 0.1326) (radius r) (material diel))

	(make sphere (center 0.2355 0.2274 0.1326) (radius r) (material diel))

	(make sphere (center -0.1024 -0.4294 0.1326) (radius r) (material diel))

	(make sphere (center 0.2355 -0.4294 0.3674) (radius r) (material diel))

	(make sphere (center 0.5544 0.2274 0.3674) (radius r) (material diel))

	(make sphere (center -0.1024 -0.1105 0.3674) (radius r) (material diel))

	(make sphere (center -0.4294 0.2355 -0.1326) (radius r) (material diel))

	(make sphere (center -0.1105 -0.1024 -0.1326) (radius r) (material diel))

	(make sphere (center 0.2274 0.5544 -0.1326) (radius r) (material diel))

	(make sphere (center -0.1105 0.5544 -0.3674) (radius r) (material diel))

	(make sphere (center -0.4294 -0.1024 -0.3674) (radius r) (material diel))

	(make sphere (center 0.2274 0.2355 -0.3674) (radius r) (material diel))
))
