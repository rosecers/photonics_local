(set! geometry-lattice (make lattice (basis-size 1.0 1.0 2.48770959) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 2.4877095941)))
...
(set! geometry (list (make sphere (center 0.3867 0.16666667 0.2296291667) (radius r) (material diel))

	(make sphere (center -0.16666667 -0.27996667 -0.1037041667) (radius r) (material diel))

	(make sphere (center 0.27996667 -0.3867 -0.4370375) (radius r) (material diel))

	(make sphere (center -0.2461 -0.2446 0.1398291667) (radius r) (material diel))

	(make sphere (center 0.2446 0.4985 -0.1935041667) (radius r) (material diel))

	(make sphere (center -0.4985 0.2461 0.4731625) (radius r) (material diel))

	(make sphere (center 0.16666667 -0.4226 0.3182291667) (radius r) (material diel))

	(make sphere (center 0.4226 0.08926667 -0.0151041667) (radius r) (material diel))

	(make sphere (center -0.08926667 -0.16666667 -0.3484375) (radius r) (material diel))

	(make sphere (center -0.16666667 -0.1176 0.3960291667) (radius r) (material diel))

	(make sphere (center 0.1176 0.45093333 0.0626958333) (radius r) (material diel))

	(make sphere (center -0.45093333 0.16666667 -0.2706375) (radius r) (material diel))

	(make sphere (center 0.168 0.2658 0.3995291667) (radius r) (material diel))

	(make sphere (center -0.2658 0.4022 0.0661958333) (radius r) (material diel))

	(make sphere (center -0.4022 -0.168 -0.2671375) (radius r) (material diel))

	(make sphere (center -0.1235 -0.321 0.2815291667) (radius r) (material diel))

	(make sphere (center 0.321 -0.3025 -0.0518041667) (radius r) (material diel))

	(make sphere (center 0.3025 0.1235 -0.3851375) (radius r) (material diel))

	(make sphere (center 0.3511 -0.3459 0.1766291667) (radius r) (material diel))

	(make sphere (center 0.3459 0.197 -0.1567041667) (radius r) (material diel))

	(make sphere (center -0.197 -0.3511 -0.4900375) (radius r) (material diel))

	(make sphere (center -0.4994 -0.0675 0.3919291667) (radius r) (material diel))

	(make sphere (center 0.0675 0.0681 0.0585958333) (radius r) (material diel))

	(make sphere (center -0.0681 0.4994 -0.2747375) (radius r) (material diel))
))
