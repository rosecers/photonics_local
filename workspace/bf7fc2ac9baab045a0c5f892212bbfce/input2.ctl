...
(set! geometry (list (make sphere (center -0.31 -0.31 -0.31) (radius r) (material diel))

	(make sphere (center 0.31 0.19 -0.19) (radius r) (material diel))

	(make sphere (center 0.19 -0.19 0.31) (radius r) (material diel))

	(make sphere (center -0.19 0.31 0.19) (radius r) (material diel))

	(make sphere (center 0.067 0.067 0.067) (radius r) (material diel))

	(make sphere (center -0.067 -0.433 0.433) (radius r) (material diel))

	(make sphere (center -0.433 0.433 -0.067) (radius r) (material diel))

	(make sphere (center 0.433 -0.067 -0.433) (radius r) (material diel))

	(make sphere (center 0.201 0.463 0.133) (radius r) (material diel))

	(make sphere (center -0.201 -0.038 0.367) (radius r) (material diel))

	(make sphere (center -0.299 0.037 -0.133) (radius r) (material diel))

	(make sphere (center 0.299 -0.462 -0.367) (radius r) (material diel))

	(make sphere (center 0.133 0.201 0.463) (radius r) (material diel))

	(make sphere (center 0.367 -0.201 -0.038) (radius r) (material diel))

	(make sphere (center -0.133 -0.299 0.037) (radius r) (material diel))

	(make sphere (center -0.367 0.299 -0.462) (radius r) (material diel))

	(make sphere (center 0.463 0.133 0.201) (radius r) (material diel))

	(make sphere (center -0.038 0.367 -0.201) (radius r) (material diel))

	(make sphere (center 0.037 -0.133 -0.299) (radius r) (material diel))

	(make sphere (center -0.462 -0.367 0.299) (radius r) (material diel))
))
