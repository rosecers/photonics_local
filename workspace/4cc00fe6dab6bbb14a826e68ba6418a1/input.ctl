...
(set! geometry (list (make sphere (center -0.2361111111 -0.2361111111 -0.2361111111) (radius r) (material diel))

	(make sphere (center 0.2638888889 0.2638888889 0.2638888889) (radius r) (material diel))

	(make sphere (center -0.4861111111 -0.4861111111 -0.4861111111) (radius r) (material diel))

	(make sphere (center 0.1168888889 0.1168888889 -0.2951111111) (radius r) (material diel))

	(make sphere (center -0.0891111111 -0.0891111111 0.3228888889) (radius r) (material diel))

	(make sphere (center 0.1168888889 -0.2951111111 0.1168888889) (radius r) (material diel))

	(make sphere (center -0.0891111111 0.3228888889 -0.0891111111) (radius r) (material diel))

	(make sphere (center 0.1168888889 0.1168888889 0.1168888889) (radius r) (material diel))

	(make sphere (center -0.0891111111 -0.0891111111 -0.0891111111) (radius r) (material diel))

	(make sphere (center -0.2951111111 0.1168888889 0.1168888889) (radius r) (material diel))

	(make sphere (center 0.3228888889 -0.0891111111 -0.0891111111) (radius r) (material diel))

	(make sphere (center 0.3868888889 0.1348888889 -0.3591111111) (radius r) (material diel))

	(make sphere (center -0.3591111111 -0.1071111111 0.3868888889) (radius r) (material diel))

	(make sphere (center -0.1071111111 -0.3591111111 0.1348888889) (radius r) (material diel))

	(make sphere (center 0.1348888889 0.3868888889 -0.1071111111) (radius r) (material diel))

	(make sphere (center 0.1348888889 -0.1071111111 -0.3591111111) (radius r) (material diel))

	(make sphere (center -0.1071111111 0.1348888889 0.3868888889) (radius r) (material diel))

	(make sphere (center -0.3591111111 0.3868888889 0.1348888889) (radius r) (material diel))

	(make sphere (center 0.3868888889 -0.3591111111 -0.1071111111) (radius r) (material diel))

	(make sphere (center -0.1071111111 0.3868888889 -0.3591111111) (radius r) (material diel))

	(make sphere (center 0.1348888889 -0.3591111111 0.3868888889) (radius r) (material diel))

	(make sphere (center 0.3868888889 -0.1071111111 0.1348888889) (radius r) (material diel))

	(make sphere (center -0.3591111111 0.1348888889 -0.1071111111) (radius r) (material diel))

	(make sphere (center 0.1438888889 0.3938888889 -0.3661111111) (radius r) (material diel))

	(make sphere (center -0.1161111111 -0.3661111111 0.3938888889) (radius r) (material diel))

	(make sphere (center 0.3938888889 0.1438888889 -0.1161111111) (radius r) (material diel))

	(make sphere (center -0.3661111111 -0.1161111111 0.1438888889) (radius r) (material diel))

	(make sphere (center 0.3938888889 -0.1161111111 -0.3661111111) (radius r) (material diel))

	(make sphere (center -0.3661111111 0.1438888889 0.3938888889) (radius r) (material diel))

	(make sphere (center 0.1438888889 -0.3661111111 -0.1161111111) (radius r) (material diel))

	(make sphere (center -0.1161111111 0.3938888889 0.1438888889) (radius r) (material diel))

	(make sphere (center -0.1161111111 0.1438888889 -0.3661111111) (radius r) (material diel))

	(make sphere (center 0.1438888889 -0.1161111111 0.3938888889) (radius r) (material diel))

	(make sphere (center -0.3661111111 0.3938888889 -0.1161111111) (radius r) (material diel))

	(make sphere (center 0.3938888889 -0.3661111111 0.1438888889) (radius r) (material diel))

	(make sphere (center 0.0138888889 0.0138888889 0.0138888889) (radius r) (material diel))
))
