...
(set! geometry (list (make sphere (center 0.3522727273 0.3522727273 0.3522727273) (radius r) (material diel))

	(make sphere (center 0.1022727273 0.1022727273 0.1022727273) (radius r) (material diel))

	(make sphere (center 0.0422727273 -0.3377272727 -0.3377272727) (radius r) (material diel))

	(make sphere (center -0.3377272727 0.0422727273 -0.3377272727) (radius r) (material diel))

	(make sphere (center -0.3377272727 -0.3377272727 0.0422727273) (radius r) (material diel))

	(make sphere (center 0.0422727273 -0.3377272727 0.0422727273) (radius r) (material diel))

	(make sphere (center 0.0422727273 0.0422727273 -0.3377272727) (radius r) (material diel))

	(make sphere (center -0.3377272727 0.0422727273 0.0422727273) (radius r) (material diel))

	(make sphere (center 0.4122727273 -0.2077272727 -0.2077272727) (radius r) (material diel))

	(make sphere (center -0.2077272727 0.4122727273 -0.2077272727) (radius r) (material diel))

	(make sphere (center -0.2077272727 -0.2077272727 0.4122727273) (radius r) (material diel))

	(make sphere (center 0.4122727273 -0.2077272727 0.4122727273) (radius r) (material diel))

	(make sphere (center 0.4122727273 0.4122727273 -0.2077272727) (radius r) (material diel))

	(make sphere (center -0.2077272727 0.4122727273 0.4122727273) (radius r) (material diel))
	...
	(make sphere (center 0.2272727273 -0.2727272727 0.2272727273) (radius r) (material diel))
))
