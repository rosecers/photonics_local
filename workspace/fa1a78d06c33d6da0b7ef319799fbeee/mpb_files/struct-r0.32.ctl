...
(set! geometry (list (make sphere (center -0.4848484848 -0.4848484848 -0.4848484848) (radius r) (material diel))
	...
	(make sphere (center 0.32711515152 -0.0408484848 -0.0408484848) (radius r) (material diel))
	(make sphere (center -0.0408484848 0.0711515152 -0.0408484848) (radius r) (material diel))
	(make sphere (center 0.32711515152 0.0711515152 0.0711515152) (radius r) (material diel))
	(make sphere (center -0.0408484848 0.0711515152 0.0711515152) (radius r) (material diel))
	(make sphere (center 0.32711515152 0.0711515152 -0.0408484848) (radius r) (material diel))
	(make sphere (center 0.32711515152 -0.0408484848 0.0711515152) (radius r) (material diel))
	(make sphere (center -0.0408484848 -0.0408484848 -0.0408484848) (radius r) (material diel))
	(make sphere (center 0.32901515152 0.0481515152 0.2841515152) (radius r) (material diel))
	(make sphere (center -0.0598484848 0.0481515152 -0.2538484848) (radius r) (material diel))
	(make sphere (center 0.32901515152 -0.0178484848 -0.2538484848) (radius r) (material diel))
	...
	(make sphere (center 0.32901515152 0.2841515152 -0.0178484848) (radius r) (material diel))
	(make sphere (center -0.0598484848 0.2841515152 0.0481515152) (radius r) (material diel))
	(make sphere (center 0.32901515152 -0.2538484848 0.0481515152) (radius r) (material diel))
	(make sphere (center 0.32481515152 0.2841515152 0.0901515152) (radius r) (material diel))
	(make sphere (center 0.32481515152 -0.2538484848 -0.0598484848) (radius r) (material diel))
	...
	(make sphere (center 0.32481515152 -0.0598484848 0.2841515152) (radius r) (material diel))
	(make sphere (center 0.32481515152 0.0901515152 -0.2538484848) (radius r) (material diel))
))
