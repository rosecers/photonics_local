(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.92305775) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.9230577515)))
...
(set! geometry (list (make sphere (center -0.04166667 -0.375 -0.3125) (radius r) (material diel))

	(make sphere (center -0.04166667 -0.04166667 0.1875) (radius r) (material diel))

	(make sphere (center -0.375 -0.04166667 -0.3125) (radius r) (material diel))

	(make sphere (center 0.29166667 -0.375 0.1875) (radius r) (material diel))

	(make sphere (center 0.29166667 0.29166667 -0.3125) (radius r) (material diel))

	(make sphere (center -0.375 0.29166667 0.1875) (radius r) (material diel))

	(make sphere (center -0.0416666667 0.2916666667 -0.0625) (radius r) (material diel))

	(make sphere (center 0.2916666667 -0.0416666667 0.4375) (radius r) (material diel))
))
