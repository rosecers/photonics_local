(set! geometry-lattice (make lattice (basis-size 1.0 1.0 0.4414743) (basis1 1.0 0.0 0.0) (basis2 -0.5 0.8660254038 0.0) (basis3 0.0 0.0 0.4414742959)))
...
(set! geometry (list (make sphere (center 0.5 0.5 0.5) (radius r) (material diel))
	...
	(make sphere (center 0.9108 0.8216 0.0) (radius r) (material diel))

	(make sphere (center 0.0892 0.1784 0.0) (radius r) (material diel))

	(make sphere (center 0.1784 0.0892 0.0) (radius r) (material diel))

	(make sphere (center 0.8216 0.9108 0.0) (radius r) (material diel))

	(make sphere (center 0.9108 0.0892 0.0) (radius r) (material diel))

	(make sphere (center 0.0892 0.9108 0.0) (radius r) (material diel))

	(make sphere (center 0.7957 0.5914 0.0) (radius r) (material diel))

	(make sphere (center 0.2043 0.4086 0.0) (radius r) (material diel))

	(make sphere (center 0.4086 0.2043 0.0) (radius r) (material diel))

	(make sphere (center 0.5914 0.7957 0.0) (radius r) (material diel))

	(make sphere (center 0.7957 0.2043 0.0) (radius r) (material diel))

	(make sphere (center 0.2043 0.7957 0.0) (radius r) (material diel))
))
